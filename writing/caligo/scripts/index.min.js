!function(){"use strict";let e=255,t=0;Page.Banner.doneLoading=!1,Page.Banner.ScrollButton.doneLoading=!1;let r=!1;function n(){Page.scroll>=0&&(Page.backgroundColorChanged=!0,0===Page.scroll?Page.backgroundColorChanged=!1:Page.scroll<=window.innerHeight/1.25?(e=.5+.5*Math.sin(Math.PI*Math.max(1-1.25*Page.scroll/window.innerHeight,0)-.5*Math.PI),1===Site.Settings.urlVars.theme?1===Site.Settings.urlVars.darkThemeColor?e=0:e*=24:e*=255,document.documentElement.style.backgroundColor=`rgb(${e}, ${e}, ${e})`,Site.Settings.metaThemeColorElement.setAttribute("content",`rgb(${e}, ${e}, ${e})`),0===e?Page.Banner.doneLoading=!0:Page.Banner.doneLoading=!1):!1===Page.Banner.doneLoading&&(document.documentElement.style.backgroundColor="rgb(0, 0, 0)",Site.Settings.metaThemeColorElement.setAttribute("content","rgb(0, 0, 0)"),Page.Banner.doneLoading=!0),function e(){if(Page.scroll<=window.innerHeight/3){t=.5+.5*Math.sin(Math.PI*Math.max(1-3*Page.scroll/window.innerHeight,0)-.5*Math.PI);try{$("#scroll-button").style.opacity=t}catch(r){}if(0===t){try{$("#scroll-button").remove()}catch(n){}Page.Banner.ScrollButton.doneLoading=!0}else Page.Banner.ScrollButton.doneLoading=!1}else if(!1===Page.Banner.ScrollButton.doneLoading){try{$("#scroll-button").remove()}catch(o){}Page.Banner.ScrollButton.doneLoading=!0}}(),Page.scroll>=.8*window.innerHeight&&Page.scroll<=6*window.innerHeight/5?(t=.5+.5*Math.sin(Math.PI*Math.max(1-3.5*(Page.scroll-.8*window.innerHeight)/window.innerHeight,0)-.5*Math.PI),$("#eclipse").style.opacity=1-t,r=1===t):scroll>=1.2*window.innerHeight&&!1===r?($("#eclipse").style.opacity=1,r=!0):scroll<=.8*window.innerHeight&&!1===r&&($("#eclipse").style.opacity=0,r=!0))}function o(){$("#eclipse").style.height=$("#eclipse").offsetWidth+"px",$("#eclipse img").style.height=$("#eclipse").offsetWidth+"px";let e=0;$$(".chapter-link a").forEach(t=>{let r=t.offsetWidth;r>e&&(e=r)}),$$(".chapter-link").forEach(t=>t.style.width=e+"px")}setTimeout(function e(){Site.addStyle(`
  ...
  `),1===Site.Settings.urlVars.contrast?(Page.setElementStyles(".synopsis-text","color","rgb(192, 192, 192)"),Page.setElementStyles(".body-text","color","rgb(192, 192, 192)"),1!==Site.Settings.urlVars.theme&&Page.setElementStyles(".hook-text","color","rgb(120, 120, 120)"),$("#email img").style.filter="brightness(150%)",Page.setElementStyles(".stage-bubble","border-color","rgb(192, 192, 192)"),Page.setElementStyles(".stage-bubble span","background-color","rgb(192, 192, 192)"),Site.addStyle(`
   ...
   `),1===Site.Settings.urlVars.theme&&Page.setElementStyles(".hook-text","color","rgb(120, 120, 120)"))},500),$("#eclipse").style.height=$("#eclipse").offsetWidth+"px",$("#eclipse img").style.height=$("#eclipse").offsetWidth+"px",window.addEventListener("resize",o),Page.temporaryHandlers.resize.push(o),window.addEventListener("scroll",n),Page.temporaryHandlers.scroll.push(n),setTimeout(o,500),setTimeout(o,1e3),0!==scroll&&(document.documentElement.classList.add("background-transition"),n(),setTimeout(()=>{document.documentElement.classList.remove("background-transition")},Site.backgroundColorAnimationTime)),setTimeout(Page.Banner.ScrollButton.insert,7e3),Page.show()}();