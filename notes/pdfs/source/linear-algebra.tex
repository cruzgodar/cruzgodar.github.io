...
\begin{center}
	...
	\normalsize Math 306 and 406\\
	
	Professor Mendes\\
	
	Cal Poly, Winter 2017--Spring 2017
\end{center}
...
\begin{Def}
	...
	Vectors $v_1, ..., v_n \in V$ are \textbf{linearly independent} if $c_1 v_1 + \cdots + c_n v_n = 0$ for $c_i \in k$ implies $c_1 = \cdots = c_n = 0$, and \textbf{linearly dependent} if not (i.e. $c_1 v_1 + \cdots + c_n v_n = 0$ for some $c_i \in k$ not all zero).
