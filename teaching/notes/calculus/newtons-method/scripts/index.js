		...
		const data =
		{
			newtonsMethod:
			{
				...
				[
					...
					{ latex: raw`x = x_1\{0 \leq y \leq f(x_1)\}`, color: desmosRed, lineStyle: "DASHED", secret: true },
					{ latex: raw`x = x_1\{f(x_1) \leq y \leq 0\}`, color: desmosRed, lineStyle: "DASHED", secret: true },
