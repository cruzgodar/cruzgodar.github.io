...
export default function()
{
	createDesmosGraphs({
		...
		limitExample:
		{
			...
			expressions:
			[
				{ latex: raw`f(x) = \frac{\sin(x)}{x}`, color: desmosColors.blue },
				{ latex: raw`(0, 1)`, color: desmosColors.blue, pointStyle: desmosPointStyles.OPEN },
				{ latex: raw`(0, -1)`, color: desmosColors.blue }
			]
		},
		...
		derivativeExample:
		{
			...
			[
				...
				{ latex: raw`f'(x)`, color: desmosColors.red, secret: true },
				{ latex: raw`(a, f'(a))`, color: desmosColors.red, dragMode: desmosDragModes.NONE, showLabel: true, secret: true },
			]
		},
		...
		secondDerivativeTest:
		{
			...
			expressions:
			[
				{ latex: raw`f(x) = x^3 - 2x^2 + 2`, color: desmosColors.purple, secret: true, hidden: true },
				{ latex: raw`f(x)`, color: desmosColors.purple },

				{ latex: raw`f'(x)`, color: desmosColors.blue },
				{ latex: raw`(0, f(0)), (\frac{4}{3}, f(\frac{4}{3}))`, color: desmosColors.blue, secret: true },

				{ latex: raw`f''(x)`, color: desmosColors.red },
				{ latex: raw`(\frac{2}{3}, f(\frac{2}{3}))`, color: desmosColors.red, secret: true },
			]
		},
		...
		secondDerivativeTest2:
		{
			...
			expressions:
			[
				{ latex: raw`g(x) = x^3 - 2x^2 + x \left\{ -1 \leq x \leq 2\right\}`, color: desmosColors.purple, secret: true, hidden: true },
				{ latex: raw`g(x)`, color: desmosColors.purple },
				{ latex: raw`g'(x)`, color: desmosColors.blue, hidden: true },
				{ latex: raw`g''(x)`, color: desmosColors.red, hidden: true },
			]
		}
	});
}