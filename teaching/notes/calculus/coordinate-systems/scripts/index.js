...
export default function()
{
	createDesmosGraphs({
		...
		extendTo3d2:
		{
			...
			expressions:
			[
				{ latex: raw`y = 1`, color: desmosPurple, hidden: true },
				{ latex: raw`z = 1`, color: desmosBlue, hidden: true },
				{ latex: raw`z = y^2`, color: desmosRed, hidden: true },
			]
		},
		...
		pointPerspective:
		{
			...
			expressions:
			[
				{ latex: raw`(a,b,c)`, color: desmosPurple },
				{ latex: raw`a = 1` },
				{ latex: raw`b = -2` },
				{ latex: raw`c = 3` },

				{ latex: raw`(a, b, c), (0, b, c), (0, 0, c), (a, 0, c), (a, b, c)`, color: desmosBlue, points: false, lines: true },
				{ latex: raw`(a, b, c), (a, 0, c), (a, 0, 0), (a, b, 0), (a, b, c)`, color: desmosBlue, points: false, lines: true },
				{ latex: raw`(a, b, c), (0, b, c), (0, b, 0), (a, b, 0), (a, b, c)`, color: desmosBlue, points: false, lines: true },
			]
		},
