	...
	setGetDesmosData(() =>
	{
		const data =
		{
			...
			tangentPlaneLevelSurface:
			{
				...
				expressions:
				[
					{ latex: raw`6x^2+2y^4+z^6+x^4z+xy^5 = 11`, color: desmosPurple3d },

					{ latex: raw`\vector((1, 1, 1), (1, 1, 1) + \frac{(17, 13, 7)}{\left|(17, 13, 7)\right|})`, color: desmosRed3d, secret: true },

					{ latex: raw`17(x - 1) + 13(y - 1) + 7(z - 1) = 0`, color: desmosBlue3d },
				]
			},
		};
