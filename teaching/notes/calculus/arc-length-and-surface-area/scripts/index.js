...
export default function()
{
	createDesmosGraphs({
		lineArcLength:
		{
			...
			expressions:
			[
				{ latex: raw`f(x) = 2x + 1 \left\{a \leq x \leq b\right\}`, color: desmosColors.purple },
				{ latex: raw`a = 0` },
				{ latex: raw`b = 2` },

				{ latex: raw`x = b\{f(a) \leq y \leq f(b)\}`, color: desmosColors.black, lineStyle: desmosLineStyles.DASHED, secret: true },
				{ latex: raw`y = f(a)\{a \leq x \leq b\}`, color: desmosColors.black, lineStyle: desmosLineStyles.DASHED, secret: true },
			]
		},
		...
		arcLengthApproximation:
		{
			...
			expressions:
			[
				{ latex: raw`f(x) = \{x=0: 1, \frac{\sin(x)}{x}\}`, color: desmosColors.purple },
				...
				{ latex: raw`y = f(A) + M(x - A) \{A \leq x \leq B\}`, color: desmosColors.blue, secret: true },
			]
		},
		...
		surfaceArea:
		{
			...
			[
				...
				{ latex: raw`((1 - m + s)x_S(\floor(t) + \frac{1}{4} + \frac{1}{4} x_0) + (m - s)x_S(\floor(t) + 1 - \frac{1}{4}x_0), (1 - m + s)y_S(\floor(t) + \frac{1}{4} + \frac{1}{4}x_0) + (m - s)y_S(\floor(t) + 1 - \frac{1}{4}x_0))`, secret: true, parametricDomain: { min: 0, max: 500 }, color: desmosColors.red },
