...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 1 | Math 1180 | Cruz Godar \vspace{4pt}  \large
...
<button class="text-button" type="button" id="download-homework-1-pdf-button" tabindex="-1"></button><button class="text-button" type="button" id="download-homework-1-tex-button" tabindex="-1"></button>
~\\
