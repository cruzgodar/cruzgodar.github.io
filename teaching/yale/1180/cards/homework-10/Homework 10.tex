...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 10 | Math 1180 | Cruz Godar \vspace{4pt}  \large

\textit{Due Sunday, December 7th at 11:59 PM}
...
<button class="text-button" type="button" id="download-homework-10-pdf-button" tabindex="-1"></button><button class="text-button" type="button" id="download-homework-10-tex-button" tabindex="-1"></button>
~\\
...
\begin{enumerate}
	...
	\item The identity matrix $I$ has the same determinant no matter what size it is. What is $\det I$?
