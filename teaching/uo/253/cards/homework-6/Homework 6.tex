...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 6 | Math 253 | Cruz Godar \vspace{4pt}  \normalsize
...
11. $\displaystyle \frac{x^4}{1 - x^2}$.

12. $\displaystyle \frac{1}{2 - x}$.

13. $\displaystyle \frac{1}{x}$.

14. $\displaystyle \frac{x}{1 - (1 - x)}$. Does your result make sense?

~\\

15. Give examples of power series with intervals of convergence of
...
16. If a power series converges at $x = 1$, does it also have to converge at $x = 0$? Why or why not?

17. Is it possible to express a function as a power series in more than one way? For example, can we express $\displaystyle \frac{1}{1 - x}$ as a power series centered at $x = \frac{1}{2}$? What happens to the interval of convergence if so? What about as a series centered at $x = 1$?
