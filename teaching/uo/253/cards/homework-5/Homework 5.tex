...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 5 | Math 253 | Cruz Godar \vspace{4pt}  \normalsize
...
\begin{enumerate}
	...
	\item What can we conclude about the relationship between the ratio test and the root test?
