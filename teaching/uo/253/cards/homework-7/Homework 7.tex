...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 7 | Math 253 | Cruz Godar \vspace{4pt}  \large

\textit{Due Wednesday of Week 8 at the start of class}

Complete the following problems and submit them as a pdf to Canvas. 8 points are awarded for thoroughly attempting every problem, and I'll select three problems to grade on correctness for 4 points each. Enough work should be shown that there is no question about the mathematical process used to obtain your answers.

<button class="text-button" type="button" id="download-homework-7-pdf-button" tabindex="-1"></button><button class="text-button" type="button" id="download-homework-7-tex-button" tabindex="-1"></button>
~\\
...
7. Let $\displaystyle f(x) = \sum_{n = 0}^\infty c_n x^n$ on $(-R, R)$, so that the series does not converge at $x = R$. Is it possible for the series for $\displaystyle \int f(x)\,\mathrm{d} x$ to converge at $x = R$? Give an example of a series where this is true or justify why no such series can exist.
