	...
	setGetDesmosData(() =>
	{
		const data =
		{
			angles:
			{
				...
				expressions:
				[
					{ latex: String.raw`y = 0 \left\{ x > 0 \right\}`, color: desmosPurple, secret: true },
					{ latex: String.raw`(t \cos(\frac{\pi}{180} a), t \sin(\frac{\pi}{180} a))`, color: desmosPurple, secret: true, parametricDomain: { min: 0, max: 100 } },
					{ latex: String.raw`r = 1 \left\{ 0 \leq \theta \leq \frac{\pi}{180} a \right\}`, color: desmosPurple, secret: true },
					{ latex: String.raw`(1.25 \cos(\frac{\pi}{360} a), 1.25 \sin(\frac{\pi}{360} a))`, color: desmosPurple, label: "θ", showLabel: true, labelSize: "large", hidden: true, secret: true },
					...getDesmosSlider({
						expression: "a = 90",
						min: 0,
						max: 360,
			...
			rightTriangle:
			{
				...
				expressions:
				[
					{ latex: String.raw`(0, 0), (4, 0), (0, 3), (0, 0)`, color: desmosPurple, points: false, lines: true, secret: true },
					{ latex: String.raw`(0, 0.25), (0.25, 0.25), (0.25, 0)`, color: desmosPurple, points: false, lines: true, secret: true },
					{ latex: String.raw`(2, -0.25)`, color: desmosPurple, label: "Leg", showLabel: true, labelSize: "large", hidden: true, secret: true },
					{ latex: String.raw`(-0.25, 1.5)`, color: desmosPurple, label: "Leg", showLabel: true, labelSize: "large", hidden: true, secret: true },
					{ latex: String.raw`(2.35, 1.75)`, color: desmosPurple, label: "Hypotenuse", showLabel: true, labelSize: "large", hidden: true, secret: true },
				]
			},
			...
			pythagoreanTheorem:
			{
				...
				expressions:
				[
					{ latex: String.raw`(0, 0), (a, 0)`, color: desmosRed, points: false, lines: true, secret: true },
					...
					{ latex: String.raw`c = \sqrt{a^2 + b^2}`, color: desmosPurple },
