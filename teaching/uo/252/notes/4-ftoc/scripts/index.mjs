	...
	setGetDesmosData(({ purple, blue, red }) =>
	{
		const data =
		{
			"ftc-part-1":
			{
				...
				expressions:
				[
					{latex: String.raw`f(x) = \frac{1}{27}x^3 - \frac{2}{9}x^2 + 2`, color: purple},
					{latex: String.raw`F(x) = \int_0^x f(t) dt`, color: blue},
					{latex: String.raw`F(c + 1) - F(c)`},
					
					{latex: String.raw`c = 2`},
					
					{latex: String.raw`x = [c, c + 1] \{0 \leq y \leq f(c)\}`, color: red, secret: true},
					{latex: String.raw`x = [c, c + 1] \{f(c) \leq y \leq 0\}`, color: red, secret: true},
					
					{latex: String.raw`0 \leq y \leq f(c) \{c \leq x \leq c + 1\}`, color: red, secret: true},
					{latex: String.raw`f(c) \leq y \leq 0 \{c \leq x \leq c + 1\}`, color: red, secret: true}
				]
			},
			...
			"ftc-part-2":
			{
				...
				expressions:
				[
					{latex: String.raw`f(x) = (x+\frac{1}{2})^3 - 2(x+\frac{1}{2})^2 + 1`, color: purple},
					{latex: String.raw`F(x) = \int_0^x f(t) dt`, color: blue},
					...
					{latex: String.raw`(b, F(b))`, secret: true, color: blue},
