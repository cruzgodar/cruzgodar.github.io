	...
	Page.Load.getDesmosData = () =>
	{
		const data =
		{
			"line-arc-length":
			{
				...
				expressions:
				[
					{latex: String.raw`f(x) = 2x + 1 \left\{a \leq x \leq b\right\}`, color: DESMOS_PURPLE},
					{latex: String.raw`a = 0`},
					{latex: String.raw`b = 2`},
					
					{latex: String.raw`x = b\{f(a) \leq y \leq f(b)\}`, color: DESMOS_BLACK, lineStyle: "DASHED", secret: true},
					{latex: String.raw`y = f(a)\{a \leq x \leq b\}`, color: DESMOS_BLACK, lineStyle: "DASHED", secret: true},
				]
			},
			...
			"arc-length-approximation":
			{
				...
				expressions:
				[
					{latex: String.raw`f(x) = \{x=0: 1, \frac{\sin(x)}{x}\}`, color: DESMOS_PURPLE},
					...
					{latex: String.raw`y = f(A) + M(x - A) \{A \leq x \leq B\}`, color: DESMOS_BLUE, secret: true},
				]
			},
			...
			"surface-area":
			{
				...
				[
					...
					{latex: String.raw`((1 - m + s)x_S(\floor(t) + \frac{1}{4} + \frac{1}{4} x_0) + (m - s)x_S(\floor(t) + 1 - \frac{1}{4}x_0), (1 - m + s)y_S(\floor(t) + \frac{1}{4} + \frac{1}{4}x_0) + (m - s)y_S(\floor(t) + 1 - \frac{1}{4}x_0))`, secret: true, parametricDomain: {min: 0, max: 500}, color: DESMOS_RED},
