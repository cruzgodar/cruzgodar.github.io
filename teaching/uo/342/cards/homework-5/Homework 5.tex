...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 5 | Math 342 | Cruz Godar \vspace{4pt}  \large

\textit{Due Wednesday of Week 6 at the start of class}

Complete the following problems and submit them as a pdf to Canvas. 8 points are awarded for thoroughly attempting every problem, and I'll select three problems to grade on correctness for 4 points each. Enough work should be shown that there is no question about the mathematical process used to obtain your answers.

<button class="text-button" type="button" id="download-homework-5-pdf-button" tabindex="-1"></button><button class="text-button" type="button" id="download-homework-5-tex-button" tabindex="-1"></button>
\section{Section 4}

In problems 1--3, use the Gram-Schmidt process to produce an orthonormal basis for the given subspace $X$. Then find the orthogonal decomposition of given vector $\vec{v}$ as $\vec{v} = \vec{x} + \vec{x}\hspace{0.1em}'$ for $\vec{x} \in X$ and $\vec{x'} \in X^\perp$.
