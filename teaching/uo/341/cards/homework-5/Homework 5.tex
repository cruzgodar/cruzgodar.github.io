...
\begin{document}\Large Name: \rule{2in}{0.15mm} \hfill Homework 5 | Math 341 | Cruz Godar \vspace{4pt}  \large
...
6. For each of the matrices $A$--$E$ in problems 1--5, classify it as invertible or noninvertible based on its determinant.
