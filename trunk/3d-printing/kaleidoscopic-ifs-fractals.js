!function()
{
	...
	wilson.render.init_uniforms(["aspect_ratio_x", "aspect_ratio_y", "image_size", "camera_pos", "image_plane_center_pos", "forward_vec", "right_vec", "up_vec", "focal_length", "light_pos", "scale_center", "n1", "n2", "n3", "n4", "num_ns", "rotation_matrix_1", "rotation_matrix_2", "z_slice"]);
	...
	function draw_frame(timestamp)
	{
		...
		frame++;
		z_slice = -1 + frame * 2 / 1000;
		wilson.gl.uniform1f(wilson.uniforms["z_slice"], z_slice);
