import{getGlslBundle,loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import anime from"/scripts/anime.min.js";import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{hsvToRgb,tempShader}from"/scripts/applets/applet.min.js";import{siteSettings}from"/scripts/src/settings.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class NewtonsMethodExtended extends AnimationFrameApplet{loadPromise;wilsonHidden;a=[1,0];c=[0,0];draggableArg=[.5,.5];aspectRatio=1;numIterations=100;pastBrightnessScales=[];resolution=500;resolutionHidden=100;derivativePrecision=6;colors;constructor({canvas}){super(canvas);var o=this.createHiddenCanvas(),t={shader:tempShader,canvasWidth:this.resolution,worldWidth:32,worldCenterX:0,worldCenterY:0,minWorldWidth:5e-5,maxWorldWidth:300,minWorldHeight:5e-5,maxWorldHeight:300,onResizeCanvas:()=>this.needNewFrame=!0,reduceMotion:siteSettings.reduceMotion,draggableOptions:{draggables:{a:this.a,c:this.c,draggableArg:[.5,.5]},callbacks:{drag:this.onDragDraggable.bind(this)}},interactionOptions:{useForPanAndZoom:!0,onPanAndZoom:()=>this.needNewFrame=!0},fullscreenOptions:{fillScreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"}};this.wilson=new WilsonGPU(canvas,t),this.wilsonHidden=new WilsonGPU(o,{...t,draggableOptions:{},canvasWidth:this.resolutionHidden}),this.wilson.draggables.draggableArg.element.style.display="none",this.loadPromise=loadGlsl()}run({generatingCode}){var o=-1!==generatingCode.indexOf("draggableArg"),t=`
