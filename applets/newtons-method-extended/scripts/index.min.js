!async function(){"use strict";await Site.loadGlsl();let e=null,o=null,r=[1,0],t=[0,0],n=1,i=1,l=[],a=500,s=20,c=0,d=0,u=0,$=0,f=0,m=0,h=0,v=0,g=-1,w=!1,_=0,p=null,C=Array(12),b=Array(12),z=Page.element.querySelector("#code-textarea");z.value="cmul(csin(z), csin(cmul(z, i)))",z.addEventListener("keydown",e=>{13===e.keyCode&&(e.preventDefault(),k())});Page.element.querySelector("#randomize-palette-button").addEventListener("click",function e(){if(!w){w=!0,_=0;let o=x();b=[...p];for(let r=0;r<12;r++)C[r]=o[r]-p[r];window.requestAnimationFrame(Z)}});Page.element.querySelector("#generate-button").addEventListener("click",k);let y=Page.element.querySelector("#resolution-input");y.addEventListener("input",()=>{a=parseInt(y.value||500),e.changeCanvasSize(a,a),window.requestAnimationFrame(Z)});let S=Page.element.querySelector("#derivative-precision-input");S.addEventListener("input",()=>{s=parseFloat(S.value||20),e.gl.uniform1f(e.uniforms.derivativePrecision,s),o.gl.uniform1f(o.uniforms.derivativePrecision,s),window.requestAnimationFrame(Z)});Page.element.querySelector("#download-button").addEventListener("click",()=>{e.downloadFrame("newtons-method.png")});let R=Page.element.querySelector("#canvas-location"),q={none:"",polynomial:"csub(cpow(z, 6.0), 1.0)",trig:"csin(z)",crosshatch:"cmul(csin(z), csin(cmul(z, i)))",palette:"cmul(sin(z), csin(cmul(z, i)))",butterflies:"cmul(sin(z), tan(z))"},F=Page.element.querySelector("#example-selector-dropdown");function k(){let n=z.value||"cmul(csin(z), csin(cmul(z, i)))",a=`
