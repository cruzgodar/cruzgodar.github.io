import anime from"/scripts/anime.min.js";import{magnitude,mat3TimesVector,RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";import{animate}from"/scripts/src/utils.min.js";class Mandelbulb extends RaymarchApplet{animeLoop;fountainFactor=0;constructor({canvas,resolution=400,useShadows=!1}){super({canvas:canvas,resolution:resolution,distanceEstimatorGlsl:`
			vec3 z = pos;
