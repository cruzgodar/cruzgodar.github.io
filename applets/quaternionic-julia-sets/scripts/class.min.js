import anime from"/scripts/anime.min.js";import{RaymarchApplet}from"/scripts/src/applets.min.js";import{aspectRatio}from"/scripts/src/layout.min.js";import{Wilson}from"/scripts/wilson.min.js";class QuaternionicJuliaSet extends RaymarchApplet{cameraPos=[-1.11619,-2.63802,1.67049];c=[-.54,-.25,-.668];lightPos=[-5,-5,5];juliaProportion=1;constructor({canvas}){super(canvas);var i={renderer:"gpu",shader:`
