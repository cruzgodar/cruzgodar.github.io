import{dotProduct4,qmul,RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";import{animate}from"/scripts/src/utils.min.js";class QuaternionicJuliaSets extends RaymarchApplet{constructor({canvas}){super({canvas:canvas,distanceEstimatorGlsl:`
		...
		`,uniforms:{c:[-.54,-.25,-.668],normalVector:[0,0,1],juliaProportion:1},stepFactor:.75,theta:1.3094,phi:1.9975,cameraPos:[-.736138,-2.75197,1.29509],lightPos:[-5,-5,5],lightBrightness:1.25})}distanceEstimator(x,y,z){var r=this.uniforms.c,o=this.uniforms.juliaProportion;let t=[x,y,z,0],e=[1,0,0,0],i=0;for(let a=0;a<16&&!(16<(i=Math.sqrt(dotProduct4(t,t))));a++)(e=qmul(...t,...e))[0]*=2,e[1]*=2,e[2]*=2,e[3]*=2,(t=qmul(...t,...t))[0]+=(1-o)*x+o*r[0],t[1]+=(1-o)*y+o*r[1],t[2]+=(1-o)*z+o*r[2];return.5*Math.log(i)*i/Math.sqrt(dotProduct4(e,e))}switchBulb(instant){var r=this.uniforms.juliaProportion;if(Math.floor(r)===r){const o=r,e=1-r;animate(t=>{this.setUniforms({juliaProportion:(1-t)*o+t*e}),this.needNewFrame=!0},instant?0:1e3,"easeInOutQuad")}}}export{QuaternionicJuliaSets};