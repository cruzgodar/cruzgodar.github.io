import anime from"/scripts/anime.min.js";import{changeOpacity}from"/scripts/src/animation.min.mjs";import{RaymarchApplet}from"/scripts/src/applets.min.mjs";import{aspectRatio}from"/scripts/src/layout.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class QuaternionicJuliaSet extends RaymarchApplet{switchBulbButtonElement=null;cXSliderElement=null;cYSliderElement=null;cZSliderElement=null;cameraPos=[-1.11619,-2.63802,1.67049];c=[-.54,-.25,-.668];lightPos=[-5,-5,5];juliaProportion=1;constructor(canvas,switchBulbButtonElement,cXSliderElement,cYSliderElement,cZSliderElement,cXSliderValueElement,cYSliderValueElement,cZSliderValueElement){super(canvas),this.switchBulbButtonElement=switchBulbButtonElement,this.cXSliderElement=cXSliderElement,this.cYSliderElement=cYSliderElement,this.cZSliderElement=cZSliderElement,this.cXSliderValueElement=cXSliderValueElement,this.cYSliderValueElement=cYSliderValueElement,this.cZSliderValueElement=cZSliderValueElement;var i={renderer:"gpu",shader:`
