import{opacityAnimationTime}from"/scripts/src/animation.min.mjs";import{Applet}from"/scripts/src/applets.min.mjs";import{aspectRatio}from"/scripts/src/layout.min.mjs";import{addTemporaryListener}from"/scripts/src/main.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class QuaternionicJuliaSet extends Applet{currentlyDragging=!1;movingForwardKeyboard=!1;movingBackwardKeyboard=!1;movingRightKeyboard=!1;movingLeftKeyboard=!1;movingSliceUpKeyboard=!1;movingSliceDownKeyboard=!1;movingForwardTouch=!1;movingBackwardTouch=!1;wasMovingTouch=!1;movingSpeed=0;switchBulbButtonElement=null;switchMovementButtonElement=null;randomizeCButtonElement=null;cXInputElement=null;cYInputElement=null;cZInputElement=null;cWInputElement=null;nextMoveVelocity=[0,0,0,0];moveVelocity=[0,0,0,0];moveFriction=.91;moveVelocityStopThreshhold=5e-4;distanceToScene=1;lastTimestamp=-1;theta=1.21557;phi=2.10801;nextThetaVelocity=0;nextPhiVelocity=0;thetaVelocity=0;phiVelocity=0;panFriction=.88;panVelocityStartThreshhold=.005;panVelocityStopThreshhold=5e-4;imageSize=500;imageWidth=500;imageHeight=500;maxIterations=16;maxMarches=100;imagePlaneCenterPos=[];forwardVec=[];rightVec=[];upVec=[];cameraPos=[-1.11619,-2.63802,1.67049];focalLength=2;lightPos=[-5,-5,5];c=[-.54,-.25,-.668];kSlice=0;juliaProportion=1;movingPos=0;constructor(t,i,e,o,s,h,a,n){super(t),this.switchBulbButtonElement=i,this.switchMovementButtonElement=e,this.randomizeCButtonElement=o,this.cXInputElement=s,this.cYInputElement=h,this.cZInputElement=a,this.cWInputElement=n;i={renderer:"gpu",shader:`
		...
		`,canvasWidth:500,canvasHeight:500,useFullscreen:!0,trueFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png",switchFullscreenCallback:()=>this.changeResolution(this.imageSize),mousedownCallback:this.onGrabCanvas.bind(this),touchstartCallback:this.onGrabCanvas.bind(this),mousedragCallback:this.onDragCanvas.bind(this),touchmoveCallback:this.onDragCanvas.bind(this),mouseupCallback:this.onReleaseCanvas.bind(this),touchendCallback:this.onReleaseCanvas.bind(this)},this.wilson=new Wilson(t,i),this.wilson.render.initUniforms(["aspectRatioX","aspectRatioY","imageSize","cameraPos","imagePlaneCenterPos","forwardVec","rightVec","upVec","focalLength","lightPos","drawSphere","c","juliaProportion","maxMarches","stepFactor","maxIterations","kSlice"]),this.calculateVectors(),this.imageWidth>=this.imageHeight?(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,this.imageWidth/this.imageHeight),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,1)):(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,1),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,this.imageWidth/this.imageHeight)),this.wilson.gl.uniform1i(this.wilson.uniforms.imageSize,this.imageSize),this.wilson.gl.uniform3fv(this.wilson.uniforms.cameraPos,this.cameraPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.imagePlaneCenterPos,this.imagePlaneCenterPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.lightPos,this.lightPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.forwardVec,this.forwardVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.rightVec,this.rightVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.upVec,this.upVec),this.wilson.gl.uniform1f(this.wilson.uniforms.focalLength,this.focalLength),this.wilson.gl.uniform1i(this.wilson.uniforms.drawSphere,0),this.wilson.gl.uniform3fv(this.wilson.uniforms.c,this.c),this.wilson.gl.uniform1f(this.wilson.uniforms.juliaProportion,1),this.wilson.gl.uniform1f(this.wilson.uniforms.kSlice,0),this.wilson.gl.uniform1i(this.wilson.uniforms.maxMarches,this.maxMarches),this.wilson.gl.uniform1f(this.wilson.uniforms.stepFactor,1),this.wilson.gl.uniform1i(this.wilson.uniforms.maxIterations,this.maxIterations),e=this.handleKeydownEvent.bind(this),addTemporaryListener({object:document.documentElement,event:"keydown",callback:e}),o=this.handleKeyupEvent.bind(this);addTemporaryListener({object:document.documentElement,event:"keyup",callback:o}),window.requestAnimationFrame(this.drawFrame.bind(this))}drawFrame(t){var i=t-this.lastTimestamp;if(this.lastTimestamp=t,0!=i){if(this.wilson.render.drawFrame(),(this.movingForwardKeyboard||this.movingBackwardKeyboard||this.movingRightKeyboard||this.movingLeftKeyboard||this.movingForwardTouch||this.movingBackwardTouch||this.movingSliceUpKeyboard||this.movingSliceDownKeyboard)&&this.updateCameraParameters(),0===this.thetaVelocity&&0===this.phiVelocity||(this.theta+=this.thetaVelocity,this.phi+=this.phiVelocity,this.theta>=2*Math.PI?this.theta-=2*Math.PI:this.theta<0&&(this.theta+=2*Math.PI),this.phi>Math.PI-.01?this.phi=Math.PI-.01:this.phi<.01&&(this.phi=.01),this.thetaVelocity*=this.panFriction,this.phiVelocity*=this.panFriction,this.thetaVelocity*this.thetaVelocity+this.phiVelocity*this.phiVelocity<this.panVelocityStopThreshhold*this.panVelocityStopThreshhold&&(this.thetaVelocity=0,this.phiVelocity=0),this.calculateVectors()),0!==this.moveVelocity[0]||0!==this.moveVelocity[1]||0!==this.moveVelocity[2]||0!==this.moveVelocity[3]){if(this.movingPos)this.cameraPos[0]+=this.moveVelocity[0],this.cameraPos[1]+=this.moveVelocity[1],this.cameraPos[2]+=this.moveVelocity[2];else{this.c[0]+=this.moveVelocity[0],this.c[1]+=this.moveVelocity[1],this.c[2]+=this.moveVelocity[2],this.kSlice+=this.moveVelocity[3];try{this.cXInputElement.value=Math.round(1e6*this.c[0])/1e6,this.cYInputElement.value=Math.round(1e6*this.c[1])/1e6,this.cZInputElement.value=Math.round(1e6*this.c[2])/1e6,this.cWInputElement.value=Math.round(1e6*this.kSlice)/1e6}catch(t){}this.wilson.gl.uniform3fv(this.wilson.uniforms.c,this.c),this.wilson.gl.uniform1f(this.wilson.uniforms.kSlice,this.kSlice)}this.moveVelocity[0]*=this.moveFriction,this.moveVelocity[1]*=this.moveFriction,this.moveVelocity[2]*=this.moveFriction,this.moveVelocity[3]*=this.moveFriction,this.moveVelocity[0]*this.moveVelocity[0]+this.moveVelocity[1]*this.moveVelocity[1]+this.moveVelocity[2]*this.moveVelocity[2]+this.moveVelocity[3]*this.moveVelocity[3]<this.moveVelocityStopThreshhold*this.movingSpeed*this.moveVelocityStopThreshhold*this.movingSpeed&&(this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0,this.moveVelocity[3]=0),this.calculateVectors()}this.animationPaused||window.requestAnimationFrame(this.drawFrame.bind(this))}}calculateVectors(){this.forwardVec=[Math.cos(this.theta)*Math.sin(this.phi),Math.sin(this.theta)*Math.sin(this.phi),Math.cos(this.phi)],this.rightVec=this.normalize([this.forwardVec[1],-this.forwardVec[0],0]),this.upVec=this.crossProduct(this.rightVec,this.forwardVec),this.distanceToScene=this.distanceEstimator(this.cameraPos[0],this.cameraPos[1],this.cameraPos[2]),this.focalLength=this.distanceToScene/2,this.rightVec[0]*=this.focalLength/2,this.rightVec[1]*=this.focalLength/2,this.upVec[0]*=this.focalLength/2,this.upVec[1]*=this.focalLength/2,this.upVec[2]*=this.focalLength/2,this.imagePlaneCenterPos=[this.cameraPos[0]+this.focalLength*this.forwardVec[0],this.cameraPos[1]+this.focalLength*this.forwardVec[1],this.cameraPos[2]+this.focalLength*this.forwardVec[2]],this.wilson.gl.uniform3fv(this.wilson.uniforms.cameraPos,this.cameraPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.imagePlaneCenterPos,this.imagePlaneCenterPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.forwardVec,this.forwardVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.rightVec,this.rightVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.upVec,this.upVec),this.wilson.gl.uniform1f(this.wilson.uniforms.focalLength,this.focalLength)}dotProduct(t,i){return t[0]*i[0]+t[1]*i[1]+t[2]*i[2]}dotProduct4(t,i){return t[0]*i[0]+t[1]*i[1]+t[2]*i[2]+t[3]*i[3]}crossProduct(t,i){return[t[1]*i[2]-t[2]*i[1],t[2]*i[0]-t[0]*i[2],t[0]*i[1]-t[1]*i[0]]}normalize(t){var i=Math.sqrt(t[0]*t[0]+t[1]*t[1]+t[2]*t[2]);return[t[0]/i,t[1]/i,t[2]/i]}qmul(t,i,e,o,s,h,a,n){return[t*s-i*h-e*e-o*n,t*h+i*s+e*n-o*a,t*a-i*n+e*s+o*h,t*n+i*a-e*h+o*s]}distanceEstimator(i,e,o){let s=[i,e,o,this.kSlice],h=[1,0,0,0],a=0;for(let t=0;t<4*this.maxIterations&&!(16<(a=Math.sqrt(this.dotProduct4(s,s))));t++)(h=this.qmul(...s,...h))[0]*=2,h[1]*=2,h[2]*=2,h[3]*=2,(s=this.qmul(...s,...s))[0]+=(1-this.juliaProportion)*i+this.juliaProportion*this.c[0],s[1]+=(1-this.juliaProportion)*e+this.juliaProportion*this.c[1],s[2]+=(1-this.juliaProportion)*o+this.juliaProportion*this.c[2],s[3]+=this.kSlice;return.5*Math.log(a)*a/Math.sqrt(this.dotProduct4(h,h))}onGrabCanvas(t,i,e){this.nextThetaVelocity=0,this.nextPhiVelocity=0,this.thetaVelocity=0,this.phiVelocity=0,"touchstart"===e.type&&(2===e.touches.length?(this.movingForwardTouch=!0,this.movingBackwardTouch=!1,this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0,this.moveVelocity[3]=0,this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0,this.nextMoveVelocity[3]=0):3===e.touches.length?(this.movingForwardTouch=!1,this.movingBackwardTouch=!0,this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0,this.moveVelocity[3]=0,this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0,this.nextMoveVelocity[3]=0):(this.movingForwardTouch=!1,this.movingBackwardTouch=!1),this.wasMovingTouch=!1)}onDragCanvas(t,i,e,o,s){"touchmove"===s.type&&this.wasMovingTouch?this.wasMovingTouch=!1:(this.theta+=e*Math.PI/2,this.nextThetaVelocity=e*Math.PI/2,this.theta>=2*Math.PI?this.theta-=2*Math.PI:this.theta<0&&(this.theta+=2*Math.PI),this.phi+=o*Math.PI/2,this.nextPhiVelocity=o*Math.PI/2,this.phi>Math.PI-.01?this.phi=Math.PI-.01:this.phi<.01&&(this.phi=.01),this.calculateVectors())}onReleaseCanvas(t,i,e){"touchend"===e.type&&(this.movingForwardTouch=!1,this.movingBackwardTouch=!1,this.wasMovingTouch=!0,0===this.moveVelocity[0])&&0===this.moveVelocity[1]&&0===this.moveVelocity[2]&&(this.moveVelocity[0]=this.nextMoveVelocity[0],this.moveVelocity[1]=this.nextMoveVelocity[1],this.moveVelocity[2]=this.nextMoveVelocity[2],this.moveVelocity[3]=this.nextMoveVelocity[3],this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0,this.nextMoveVelocity[3]=0),("touchend"===e.type&&0===e.touches.length||"mouseup"===e.type)&&this.nextThetaVelocity*this.nextThetaVelocity+this.nextPhiVelocity*this.nextPhiVelocity>=this.panVelocityStartThreshhold*this.panVelocityStartThreshhold&&(this.thetaVelocity=this.nextThetaVelocity,this.phiVelocity=this.nextPhiVelocity)}handleKeydownEvent(t){"INPUT"===document.activeElement.tagName||"w"!==t.key&&"s"!==t.key&&"d"!==t.key&&"a"!==t.key&&"e"!==t.key&&"q"!==t.key||(this.nextMoveVelocity=[0,0,0,0],this.moveVelocity=[0,0,0,0],"w"===t.key?this.movingForwardKeyboard=!0:"s"===t.key&&(this.movingBackwardKeyboard=!0),"d"===t.key?this.movingRightKeyboard=!0:"a"===t.key&&(this.movingLeftKeyboard=!0),"e"===t.key?this.movingSliceUpKeyboard=!0:"q"===t.key&&(this.movingSliceDownKeyboard=!0))}handleKeyupEvent(t){"INPUT"===document.activeElement.tagName||"w"!==t.key&&"s"!==t.key&&"d"!==t.key&&"a"!==t.key&&"e"!==t.key&&"q"!==t.key||(0===this.moveVelocity[0]&&0===this.moveVelocity[1]&&0===this.moveVelocity[2]&&0===this.moveVelocity[3]&&(this.moveVelocity[0]=this.nextMoveVelocity[0],this.moveVelocity[1]=this.nextMoveVelocity[1],this.moveVelocity[2]=this.nextMoveVelocity[2],this.moveVelocity[3]=this.nextMoveVelocity[3],this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0,this.nextMoveVelocity[3]=0),"w"===t.key?this.movingForwardKeyboard=!1:"s"===t.key&&(this.movingBackwardKeyboard=!1),"d"===t.key?this.movingRightKeyboard=!1:"a"===t.key&&(this.movingLeftKeyboard=!1),"e"===t.key?this.movingSliceUpKeyboard=!1:"q"===t.key&&(this.movingSliceDownKeyboard=!1))}updateCameraParameters(){if(this.movingSpeed=Math.min(Math.max(1e-6,this.distanceToScene/20),.02),this.movingPos){var t=[...this.cameraPos];this.movingForwardKeyboard||this.movingForwardTouch?(this.cameraPos[0]+=this.movingSpeed*this.forwardVec[0],this.cameraPos[1]+=this.movingSpeed*this.forwardVec[1],this.cameraPos[2]+=this.movingSpeed*this.forwardVec[2]):(this.movingBackwardKeyboard||this.movingBackwardTouch)&&(this.cameraPos[0]-=this.movingSpeed*this.forwardVec[0],this.cameraPos[1]-=this.movingSpeed*this.forwardVec[1],this.cameraPos[2]-=this.movingSpeed*this.forwardVec[2]),this.movingRightKeyboard?(this.cameraPos[0]+=this.movingSpeed*this.rightVec[0]/this.focalLength,this.cameraPos[1]+=this.movingSpeed*this.rightVec[1]/this.focalLength,this.cameraPos[2]+=this.movingSpeed*this.rightVec[2]/this.focalLength):this.movingLeftKeyboard&&(this.cameraPos[0]-=this.movingSpeed*this.rightVec[0]/this.focalLength,this.cameraPos[1]-=this.movingSpeed*this.rightVec[1]/this.focalLength,this.cameraPos[2]-=this.movingSpeed*this.rightVec[2]/this.focalLength),this.nextMoveVelocity[0]=this.cameraPos[0]-t[0],this.nextMoveVelocity[1]=this.cameraPos[1]-t[1],this.nextMoveVelocity[2]=this.cameraPos[2]-t[2]}else{var t=[...this.c],i=this.kSlice;this.movingForwardKeyboard||this.movingForwardTouch?(this.c[0]+=.5*this.movingSpeed*this.forwardVec[0],this.c[1]+=.5*this.movingSpeed*this.forwardVec[1],this.c[2]+=.5*this.movingSpeed*this.forwardVec[2]):(this.movingBackwardKeyboard||this.movingBackwardTouch)&&(this.c[0]-=.5*this.movingSpeed*this.forwardVec[0],this.c[1]-=.5*this.movingSpeed*this.forwardVec[1],this.c[2]-=.5*this.movingSpeed*this.forwardVec[2]),this.movingRightKeyboard?(this.c[0]+=.5*this.movingSpeed*this.rightVec[0]/this.focalLength,this.c[1]+=.5*this.movingSpeed*this.rightVec[1]/this.focalLength,this.c[2]+=.5*this.movingSpeed*this.rightVec[2]/this.focalLength):this.movingLeftKeyboard&&(this.c[0]-=.5*this.movingSpeed*this.rightVec[0]/this.focalLength,this.c[1]-=.5*this.movingSpeed*this.rightVec[1]/this.focalLength,this.c[2]-=.5*this.movingSpeed*this.rightVec[2]/this.focalLength),this.movingSliceUpKeyboard?this.kSlice+=.5*this.movingSpeed:this.movingSliceDownKeyboard&&(this.kSlice-=.5*this.movingSpeed);try{this.cXInputElement.value=Math.round(1e6*this.c[0])/1e6,this.cYInputElement.value=Math.round(1e6*this.c[1])/1e6,this.cZInputElement.value=Math.round(1e6*this.c[2])/1e6,this.cWInputElement.value=Math.round(1e6*this.kSlice)/1e6}catch(t){}this.wilson.gl.uniform3fv(this.wilson.uniforms.c,this.c),this.wilson.gl.uniform1f(this.wilson.uniforms.kSlice,this.kSlice),this.nextMoveVelocity[0]=this.c[0]-t[0],this.nextMoveVelocity[1]=this.c[1]-t[1],this.nextMoveVelocity[2]=this.c[2]-t[2],this.nextMoveVelocity[3]=this.kSlice-i}this.calculateVectors()}changeResolution(t){this.imageSize=t,this.wilson.fullscreen.currentlyFullscreen?1<=aspectRatio?(this.imageWidth=this.imageSize,this.imageHeight=Math.floor(this.imageSize/aspectRatio)):(this.imageWidth=Math.floor(this.imageSize*aspectRatio),this.imageHeight=this.imageSize):(this.imageWidth=this.imageSize,this.imageHeight=this.imageSize),this.wilson.changeCanvasSize(this.imageWidth,this.imageHeight),this.imageWidth>=this.imageHeight?(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,this.imageWidth/this.imageHeight),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,1)):(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,1),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,this.imageWidth/this.imageHeight)),this.wilson.gl.uniform1i(this.wilson.uniforms.imageSize,this.imageSize)}randomizeC(t=!0){this.updateC([2*Math.random()-1,2*Math.random()-1,2*Math.random()-1,this.c[3]],t)}updateC(t,i=!0){try{this.cXInputElement.value=Math.round(1e6*t[0])/1e6,this.cYInputElement.value=Math.round(1e6*t[1])/1e6,this.cZInputElement.value=Math.round(1e6*t[2])/1e6}catch(t){}let e={t:0};const o=[...this.c];anime({targets:e,t:1,duration:1500*i+10,easing:"easeOutQuad",update:()=>{this.c[0]=(1-e.t)*o[0]+e.t*t[0],this.c[1]=(1-e.t)*o[1]+e.t*t[1],this.c[2]=(1-e.t)*o[2]+e.t*t[2],this.wilson.gl.uniform3fv(this.wilson.uniforms.c,this.c)}})}switchBulb(){if(0===this.juliaProportion||1===this.juliaProportion){const i=this.juliaProportion,e=1-this.juliaProportion;try{changeOpacity(this.switchBulbButtonElement,0),setTimeout(()=>{0===i?this.switchBulbButtonElement.textContent="Switch to Mandelbrot Set":this.switchBulbButtonElement.textContent="Switch to Julia Set",changeOpacity(this.switchBulbButtonElement,1)},opacityAnimationTime)}catch(t){}if(0===this.juliaProportion)this.wilson.gl.uniform3fv(this.wilson.uniforms.c,this.c),this.movingPos||this.wilson.gl.uniform1i(this.wilson.uniforms.drawSphere,1),setTimeout(()=>{try{changeOpacity(this.switchMovementButtonElement,1),changeOpacity(this.randomizeCButtonElement,1)}catch(t){}},opacityAnimationTime);else{this.movingPos=!0,this.wilson.gl.uniform1i(this.wilson.uniforms.drawSphere,0);try{changeOpacity(this.switchMovementButtonElement,0),changeOpacity(this.randomizeCButtonElement,0)}catch(t){}}let t={t:0};anime({targets:t,t:1,duration:1500,easing:"easeOutQuad",update:()=>{this.juliaProportion=(1-t.t)*i+t.t*e,this.wilson.gl.uniform1f(this.wilson.uniforms.juliaProportion,this.juliaProportion)}})}}switchMovement(){this.movingPos=!this.movingPos;try{changeOpacity(this.switchMovementButtonElement,0),setTimeout(()=>{this.movingPos?this.switchMovementButtonElement.textContent="Change Julia Set":this.switchMovementButtonElement.textContent="Move Camera",changeOpacity(this.switchMovementButtonElement,1)},opacityAnimationTime)}catch(t){}this.movingPos?this.wilson.gl.uniform1i(this.wilson.uniforms.drawSphere,0):this.wilson.gl.uniform1i(this.wilson.uniforms.drawSphere,1)}}export{QuaternionicJuliaSet};