import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";import{aspectRatio}from"/scripts/src/layout.min.js";import{addTemporaryListener}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";class ExtrudedSponge extends RaymarchApplet{scale=2;maxIterations=16;cameraPos=[2,2,2];theta=1.25*Math.PI;phi=.75*Math.PI;constructor({canvas}){super(canvas);var t={renderer:"gpu",shader:`
