import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class EllipticCurve extends AnimationFrameApplet{resolution=500;g2=-2;g3=2;constructor({canvas}){super(canvas);var e={shaders:{shader:`
		...
		`},uniforms:{shader:{step:8/this.resolution,g2Arg:this.g2,g3Arg:this.g3},shader2:{textureStep:1/this.resolution}},canvasWidth:this.resolution,worldWidth:8,worldCenterX:0,worldCenterY:0};this.wilson=new WilsonGPU(canvas,e),this.wilson.createFramebufferTexturePair({id:"0",textureType:"unsignedByte"}),this.wilson.useFramebuffer(null),this.resume()}run({g2,g3}){this.g2=g2,this.g3=g3,this.needNewFrame=!0}drawFrame(){this.wilson.useShader("shader"),this.wilson.setUniforms({g2Arg:this.g2,g3Arg:this.g3}),this.wilson.drawFrame();var i=this.wilson.readPixels(),o=[],a=this.resolution,e=this.wilson.canvasWidth;for(let r=2;r<this.wilson.canvasHeight-2;r++)for(let e=2;e<a-2;e++){var t=a*r+e;0!==i[4*t]&&i[4*(t-1)]+i[4*(t+1)]+i[4*(t-a)]+i[4*(t+a)]+i[4*(t-1-a)]+i[4*(t+1-a)]+i[4*(t-1+a)]+i[4*(t+1+a)]<=255&&(t=i[4*(t-2*a-2)]+i[4*(t-2*a-1)]+i[4*(t-2*a)]+i[4*(t-2*a+1)]+i[4*(t-2*a+2)]+i[4*(t+2*a-2)]+i[4*(t+2*a-1)]+i[4*(t+2*a)]+i[4*(t+2*a+1)]+i[4*(t+2*a+2)]+i[4*(t-a-2)]+i[4*(t-2)]+i[4*(t+a-2)]+i[4*(t-a+2)]+i[4*(t+2)]+i[4*(t+a+2)],o.push(0===t?[r,e,!0]:[r,e,!1]))}for(let p=0;p<o.length;p++)if(!(o[p][0]<this.wilson.canvasWidth/20||o[p][1]<this.wilson.canvasHeight/20||o[p][0]>19*this.wilson.canvasWidth/20||o[p][1]>19*this.wilson.canvasHeight/20)){let t=-1,r=e;o[p][2]||(r=e/20);for(let s=0;s<o.length;s++)if(s!==p){var n=Math.sqrt((o[p][0]-o[s][0])*(o[p][0]-o[s][0])+(o[p][1]-o[s][1])*(o[p][1]-o[s][1]));if(n<r&&2<=n){var u,h,l=(o[s][0]-o[p][0])/n*1.414214,c=(o[s][1]-o[p][1])/n*1.414214,l=Math.sign(l)*Math.floor(Math.abs(l)),c=Math.sign(c)*Math.floor(Math.abs(c));let e=0;0==l?(u=a*(o[p][0]+l)+(o[p][1]+c),e+=i[4*u],u=a*(o[p][0]+l+1)+(o[p][1]+c),e+=i[4*u],u=a*(o[p][0]+l-1)+(o[p][1]+c),e+=i[4*u]):0==c?(u=a*(o[p][0]+l)+(o[p][1]+c),e+=i[4*u],u=a*(o[p][0]+l)+(o[p][1]+c+1),e+=i[4*u],u=a*(o[p][0]+l)+(o[p][1]+c-1),e+=i[4*u]):(h=a*(o[p][0]+l)+(o[p][1]+c),e+=i[4*h],h=a*o[p][0]+(o[p][1]+c),e+=i[4*h],h=a*(o[p][0]+l)+o[p][1],e+=i[4*h]),0===e&&(t=s,r=n)}}if(-1!==t)for(let e=1;e<2*r;e++){var f=e/(2*r),f=a*Math.round((1-f)*o[p][0]+f*o[t][0])+Math.round((1-f)*o[p][1]+f*o[t][1]);i[4*f]=0,i[4*f+1]=255,i[4*f+2]=0}}this.wilson.useShader("shader2"),this.wilson.setTexture({id:"0",data:i}),this.wilson.drawFrame()}changeResolution(resolution){this.resolution=resolution,this.wilson.resizeCanvas({width:this.resolution}),this.wilson.setUniforms({step:this.wilson.worldWidth/this.resolution},"shader"),this.wilson.setUniforms({textureStep:1/this.resolution},"shader2"),this.wilson.createFramebufferTexturePair({id:"0",textureType:"unsignedByte"}),this.wilson.useFramebuffer(null),this.needNewFrame=!0}}export{EllipticCurve};