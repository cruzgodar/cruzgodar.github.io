import{Applet}from"/scripts/src/applets.min.min.min.mjs";class EllipticCurve extends Applet{resolution=500;g2=-2;g3=0;lastTimestamp=-1;constructor(t){super(t);var e={renderer:"gpu",shader:`
