function createShader({maxMarches,maxT,stepFactor,uniformGlsl,dotProductGlsl,normalizeGlsl,functionGlsl,posSignature,distanceEstimatorGlsl,getColorGlsl,addFiberArgument,lightGlsl,ambientOcclusionDenominator,doClipBrightening,fogGlsl,raymarchSetupGlsl,geodesicGlsl,finalTeleportationGlsl,updateTGlsl,useReflections=!1}){var t=`
	...
	`;return window.DEBUG&&console.log(t),t}export{createShader};