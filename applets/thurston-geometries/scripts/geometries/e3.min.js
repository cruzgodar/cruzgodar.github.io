import{BaseGeometry,getMinGlslString}from"./base.min.js";import{$}from"/scripts/src/main.min.js";class E3Geometry extends BaseGeometry{}class E3Axes extends E3Geometry{static distances=`
	...
	`;uniformNames=["sceneTransition","wallThickness"];updateUniforms(gl,uniformList){var s=1.5-(this.sliderValues.wallThickness+.85)/2*.2;gl.uniform1f(uniformList.sceneTransition,this.sliderValues.sceneTransition),gl.uniform1f(uniformList.wallThickness,s)}uiElementsUsed="#wall-thickness-slider";initUI(){var s=$("#wall-thickness-slider"),e=$("#wall-thickness-slider-value");s.min=-.85,s.max=1.55,s.value=1.55,e.textContent=1.55,this.sliderValues.wallThickness=1.55}getRelocatedCameraPos(newSceneTransition){var s=[this.cameraPos[0]%2,this.cameraPos[1]%2,this.cameraPos[2]%2,1];return 1===newSceneTransition?[this.cameraPos[0]-s[0],this.cameraPos[1]-s[1],this.cameraPos[2]-s[2],1]:[this.cameraPos[0]-s[0]+1,this.cameraPos[1]-s[1]+1,this.cameraPos[2]-s[2]+1,1]}}export{E3Geometry,E3Axes,E3Rooms};