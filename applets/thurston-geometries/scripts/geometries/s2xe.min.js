import{sliderValues}from"../index.min.js";import{BaseGeometry,getMaxGlslString,getMinGlslString}from"./base.min.js";import{$}from"/scripts/src/main.min.js";class S2xEGeometry extends BaseGeometry{geodesicGlsl=`
		vec4 pos = vec4(
	...
	`;correctPosition(pos){var s=Math.sqrt(pos[0]*pos[0]+pos[1]*pos[1]+pos[2]*pos[2]);return[pos[0]/s,pos[1]/s,pos[2]/s,pos[3]]}getNormalVec(cameraPos){return this.normalize([-cameraPos[0],-cameraPos[1],-cameraPos[2],0])}}class S2xERooms extends S2xEGeometry{static distances=`
		float spacing = 1.09;
