import{BaseGeometry}from"./base.min.js";import{getMaxGlslString,getMinGlslString}from"/scripts/src/applets.min.js";class S2xEGeometry extends BaseGeometry{geodesicGlsl=`
		vec4 pos = vec4(
	...
	`;correctPosition(pos){var o=Math.sqrt(pos[0]*pos[0]+pos[1]*pos[1]+pos[2]*pos[2]);return[pos[0]/o,pos[1]/o,pos[2]/o,pos[3]]}getNormalVec(cameraPos){return this.normalize([-cameraPos[0],-cameraPos[1],-cameraPos[2],0])}}class S2xEAxes extends S2xEGeometry{static distances=`
	...
	`;uniformNames=["sceneTransition","wallThickness"];updateUniforms(gl,uniformList){var o=.9557-this.sliderValues.wallThickness/10;gl.uniform1f(uniformList.sceneTransition,this.sliderValues.sceneTransition),gl.uniform1f(uniformList.wallThickness,o)}uiElementsUsed="#wall-thickness-slider, #switch-scene-button";wallThicknessData=[.8,-.45,.8];getNearestCenter(){var o=1.09,s=(this.cameraPos[3]+o/2)%o,e=[[1,0,0,-o],[-1,0,0,-o],[0,1,0,-o],[0,-1,0,-o],[0,0,1,-o],[0,0,-1,-o],[1,0,0,o],[-1,0,0,o],[0,1,0,o],[0,-1,0,o],[0,0,1,o],[0,0,-1,o]];let i=Math.PI,t=0;for(let r=0;r<e.length;r++){var a=Math.acos(e[r][0]*this.cameraPos[0]+e[r][1]*this.cameraPos[1]+e[r][2]*this.cameraPos[2]),n=s-e[r][3],a=a*a+n*n;a<i&&(i=a,t=r)}return[e[t][0],e[t][1],e[t][2],this.cameraPos[3]-s+e[t][3]]}getNearestCorner(){var o=1.09,s=(this.cameraPos[3]+o/2)%o,e=1/Math.sqrt(3),i=[[e,e,e,o/2],[e,e,e,-o/2],[e,e,-e,o/2],[e,e,-e,-o/2],[e,-e,e,o/2],[e,-e,e,-o/2],[e,-e,-e,o/2],[e,-e,-e,-o/2],[-e,e,e,o/2],[-e,e,e,-o/2],[-e,e,-e,o/2],[-e,e,-e,-o/2],[-e,-e,e,o/2],[-e,-e,e,-o/2],[-e,-e,-e,o/2],[-e,-e,-e,-o/2]];let t=Math.PI,a=0;for(let c=0;c<i.length;c++){var n=Math.acos(i[c][0]*this.cameraPos[0]+i[c][1]*this.cameraPos[1]+i[c][2]*this.cameraPos[2]),r=s-i[c][3],n=n*n+r*r;n<t&&(t=n,a=c)}return[i[a][0],i[a][1],i[a][2],this.cameraPos[3]-s+i[a][3]]}}export{S2xEGeometry,S2xEAxes,S2xERooms};