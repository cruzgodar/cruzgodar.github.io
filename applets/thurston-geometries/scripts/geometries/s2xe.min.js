...
`;class S2xERooms extends S2xEGeometry{distanceEstimatorGlsl=`
	...
	`;uniformNames=["sceneTransition","wallThickness"];getUpdatedUniforms(){return{wallThickness:.9557-this.sliderValues.wallThickness/10,clipDistance:this.sliderValues.clipDistance,sceneTransition:this.sliderValues.sceneTransition}}uiElementsUsed="#wall-thickness-slider, #switch-scene-button, #clip-distance-slider";wallThicknessData=[.8,-.45,.8];doClipBrightening=!0;getNearestCenter(){var o=1.09,e=(this.cameraPos[3]+o/2)%o,s=[[1,0,0,-o/2],[-1,0,0,-o/2],[0,1,0,-o/2],[0,-1,0,-o/2],[0,0,1,-o/2],[0,0,-1,-o/2],[1,0,0,o/2],[-1,0,0,o/2],[0,1,0,o/2],[0,-1,0,o/2],[0,0,1,o/2],[0,0,-1,o/2]];let t=Math.PI,a=0;for(let n=0;n<s.length;n++){var i=Math.acos(s[n][0]*this.cameraPos[0]+s[n][1]*this.cameraPos[1]+s[n][2]*this.cameraPos[2]),c=e-s[n][3],i=i*i+c*c;i<t&&(t=i,a=n)}return[s[a][0],s[a][1],s[a][2],this.cameraPos[3]-e+s[a][3]]}getNearestCorner(){var o=1.09,e=(this.cameraPos[3]+o/2)%o-o/2,s=1/Math.sqrt(3),t=[[s,s,s,o/2],[s,s,s,-o/2],[s,s,-s,o/2],[s,s,-s,-o/2],[s,-s,s,o/2],[s,-s,s,-o/2],[s,-s,-s,o/2],[s,-s,-s,-o/2],[-s,s,s,o/2],[-s,s,s,-o/2],[-s,s,-s,o/2],[-s,s,-s,-o/2],[-s,-s,s,o/2],[-s,-s,s,-o/2],[-s,-s,-s,o/2],[-s,-s,-s,-o/2]];let a=Math.PI,i=0;for(let r=0;r<t.length;r++){var c=Math.acos(t[r][0]*this.cameraPos[0]+t[r][1]*this.cameraPos[1]+t[r][2]*this.cameraPos[2]),n=e-t[r][3],c=c*c+n*n;c<a&&(a=c,i=r)}return[t[i][0],t[i][1],t[i][2],this.cameraPos[3]-e+t[i][3]]}}export{S2xEGeometry,S2xEAxes,S2xERooms};