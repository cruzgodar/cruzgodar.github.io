...
`;class S2xERooms extends S2xEGeometry{distanceEstimatorGlsl=`
	...
	`;uniformNames=["sceneTransition","wallThickness"];updateUniforms(gl,uniformList,programIndex){var o=.9557-this.sliderValues.wallThickness/10;gl.uniform1f(uniformList.sceneTransition[programIndex],this.sliderValues.sceneTransition),gl.uniform1f(uniformList.clipDistance[programIndex],this.sliderValues.clipDistance),gl.uniform1f(uniformList.wallThickness[programIndex],o)}uiElementsUsed="#wall-thickness-slider, #switch-scene-button, #clip-distance-slider";wallThicknessData=[.8,-.45,.8];doClipBrightening=!0;getNearestCenter(){var o=1.09,s=(this.cameraPos[3]+o/2)%o,e=[[1,0,0,-o/2],[-1,0,0,-o/2],[0,1,0,-o/2],[0,-1,0,-o/2],[0,0,1,-o/2],[0,0,-1,-o/2],[1,0,0,o/2],[-1,0,0,o/2],[0,1,0,o/2],[0,-1,0,o/2],[0,0,1,o/2],[0,0,-1,o/2]];let i=Math.PI,a=0;for(let r=0;r<e.length;r++){var t=Math.acos(e[r][0]*this.cameraPos[0]+e[r][1]*this.cameraPos[1]+e[r][2]*this.cameraPos[2]),n=s-e[r][3],t=t*t+n*n;t<i&&(i=t,a=r)}return[e[a][0],e[a][1],e[a][2],this.cameraPos[3]-s+e[a][3]]}getNearestCorner(){var o=1.09,s=(this.cameraPos[3]+o/2)%o-o/2,e=1/Math.sqrt(3),i=[[e,e,e,o/2],[e,e,e,-o/2],[e,e,-e,o/2],[e,e,-e,-o/2],[e,-e,e,o/2],[e,-e,e,-o/2],[e,-e,-e,o/2],[e,-e,-e,-o/2],[-e,e,e,o/2],[-e,e,e,-o/2],[-e,e,-e,o/2],[-e,e,-e,-o/2],[-e,-e,e,o/2],[-e,-e,e,-o/2],[-e,-e,-e,o/2],[-e,-e,-e,-o/2]];let a=Math.PI,t=0;for(let c=0;c<i.length;c++){var n=Math.acos(i[c][0]*this.cameraPos[0]+i[c][1]*this.cameraPos[1]+i[c][2]*this.cameraPos[2]),r=s-i[c][3],n=n*n+r*r;n<a&&(a=n,t=c)}return[i[t][0],i[t][1],i[t][2],this.cameraPos[3]-s+i[t][3]]}}export{S2xEGeometry,S2xEAxes,S2xERooms};