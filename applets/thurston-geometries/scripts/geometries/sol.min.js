import{BaseGeometry,getMaxGlslString}from"./base.min.js";const numericalStepDistance=2e-5,flowNumericallyThreshhold=.002,flowNearPlaneThreshhold=1e-4,maxNumericalSteps=Math.ceil(flowNumericallyThreshhold/numericalStepDistance);class SolGeometry extends BaseGeometry{geodesicGlsl=`
	...
	`;lightGlsl=`
		...
		lightIntensity = 1.0;
	`;cameraPos=[0,0,0,1];normalVec=[0,0,0,1];upVec=[0,0,1,0];rightVec=[0,1,0,0];forwardVec=[1,0,0,0]}export{SolRooms};