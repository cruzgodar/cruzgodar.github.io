import{ThurstonGeometry}from"../class.min.mjs";import{getMinGlslString}from"./base.min.mjs";import{BaseGeometry}from"./base.min.mjs";class H3Geometry extends BaseGeometry{geodesicGlsl="vec4 pos = cosh(t) * cameraPos + sinh(t) * rayDirectionVec;";fogGlsl=`return mix(
		color,
		fogColor,
