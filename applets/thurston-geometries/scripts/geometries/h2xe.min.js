import{getMatrixGlsl,getMinGlslString,getVectorGlsl}from"../../../../scripts/applets/applet.min.js";import{ThurstonGeometry}from"../class.min.js";import{BaseGeometry}from"./base.min.js";const teleportations=[[[1,0,1/Math.sqrt(3),0],[[2,0,Math.sqrt(3),0],[0,1,0,0],[Math.sqrt(3),0,2,0],[0,0,0,1]]],[[-1,0,1/Math.sqrt(3),0],[[2,0,-Math.sqrt(3),0],[0,1,0,0],[-Math.sqrt(3),0,2,0],[0,0,0,1]]],[[0,1,1/Math.sqrt(3),0],[[1,0,0,0],[0,2,Math.sqrt(3),0],[0,Math.sqrt(3),2,0],[0,0,0,1]]],[[0,-1,1/Math.sqrt(3),0],[[1,0,0,0],[0,2,-Math.sqrt(3),0],[0,-Math.sqrt(3),2,0],[0,0,0,1]]]];class H2xEGeometry extends BaseGeometry{geodesicGlsl=`
	...
	`;uniformNames=["sceneTransition","wallThickness","baseColor"];updateUniforms(gl,uniformList){gl.uniform1f(uniformList.sceneTransition,this.sliderValues.sceneTransition);var t=1.145-this.sliderValues.wallThickness/10;console.log(t),gl.uniform1f(uniformList.wallThickness,t),gl.uniform3fv(uniformList.baseColor,this.baseColor)}uiElementsUsed="#wall-thickness-slider, #switch-scene-button";wallThicknessData=[1.55,-3.55,1.55];getNearestCenter(){return[0,0,1,1.875*Math.round(this.cameraPos[3]/1.875)]}getNearestCorner(){var t=1.875,e=(this.cameraPos[3]+t/2)%t,o=[[1,1,Math.sqrt(3),t/2],[1,-1,Math.sqrt(3),t/2],[-1,1,Math.sqrt(3),t/2],[-1,-1,Math.sqrt(3),t/2],[1,1,Math.sqrt(3),-t/2],[1,-1,Math.sqrt(3),-t/2],[-1,1,Math.sqrt(3),-t/2],[-1,-1,Math.sqrt(3),-t/2]];let r=1/0,s=0;for(let c=0;c<o.length;c++){var a=Math.acosh(this.cameraPos[0]*o[c][0]+this.cameraPos[1]*o[c][1]+this.cameraPos[2]*o[c][2]),i=e-o[c][3],a=a*a+i*i;a<r&&(r=a,s=c)}return o[s]}}export{H2xEAxes,H2xERooms};