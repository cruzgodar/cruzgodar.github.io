...
// Trunk code that correctly teleports the marched ray within a single cube.
export class S3RoomsTeleport extends S3Geometry
{
	functionGlsl = `
	...
	raymarchSetupGlsl = "ivec4 oldClosestPoint = closestQ8Point(startPos);";
