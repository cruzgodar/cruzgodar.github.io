import{Applet}from"/scripts/src/applets.min.mjs";import{aspectRatio}from"/scripts/src/layout.min.mjs";import{addTemporaryListener}from"/scripts/src/main.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class ThurstonGeometry extends Applet{resolution=500;aspectRatioX=1;aspectRatioY=1;cameraPos;orthonormalFrame=[[],[],[],[]];normalVec;upVec;rightVec;forwardVec;rotatedForwardVec;rotatedUpVec;movingAmount=[0,0,0];getMovingSpeed;updateCameraPos;getNormalVec;getGammaPrime;getGammaDoublePrime;getGammaTriplePrime;constructor({canvas}){super(canvas);var e={renderer:"gpu",shader:`
