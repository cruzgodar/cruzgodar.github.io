import{Applet}from"/scripts/src/applets.min.mjs";import{aspectRatio}from"/scripts/src/layout.min.mjs";import{addTemporaryListener}from"/scripts/src/main.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class ThurstonGeometry extends Applet{resolution=1e3;aspectRatioX=1;aspectRatioY=1;cameraPos;normalVec;upVec;rightVec;forwardVec;movingAmount=[0,0];lastWorldCenterX;lastWorldCenterY;updateCameraPos;getNormalVec;getGammaPrime;getGammaDoublePrime;constructor({canvas}){super(canvas);var t={renderer:"gpu",shader:`
