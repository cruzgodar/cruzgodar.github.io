import{getGlslBundle,loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{getFloatGlsl,getMaxGlslString,tempShader}from"/scripts/applets/applet.min.js";import{sleep}from"/scripts/src/utils.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class VectorField extends AnimationFrameApplet{loadPromise;resolution=500;subpixelWorldCenterMovement=[0,0];lastWorldCenterX;lastWorldCenterY;lastWorldWidth;lastScale=1;needTemporaryDim=!1;lastGeneratedCanvasWidth;lastGeneratedCanvasHeight;numParticles=0;maxParticles=5e3;loopEdges=!1;particleDilation;needStepSize=!0;dt=.00375;lifetime=150;particles=[];freeParticleSlots=[];updateTexture;panZoomDimTexture;updateCanvas;panZoomDimCanvas;wilsonUpdate;wilsonPanZoomDim;timeElapsedHistoryLength=60;lastTimeElapsed=new Array(this.timeElapsedHistoryLength);averageTimeElapsed;frame=0;onDrawFrame;constructor({canvas,loopEdges=!1,transparency=!1,useFullscreenButton=!0,onDrawFrame=()=>{},onReset=()=>{}}){super(canvas),this.loopEdges=loopEdges,this.onDrawFrame=onDrawFrame,this.panZoomDimCanvas=this.createHiddenCanvas(),this.updateCanvas=this.createHiddenCanvas();var e={shader:tempShader,canvasWidth:100,canvasHeight:100,verbose:window.DEBUG},e=(this.wilsonUpdate=new WilsonGPU(this.updateCanvas,e),`
