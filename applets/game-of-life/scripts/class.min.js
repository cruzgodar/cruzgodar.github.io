import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{sleep}from"/scripts/src/utils.min.js";import{WilsonGL}from"/scripts/wilson.min.js";class GameOfLife extends AnimationFrameApplet{gridSize=100;resolution=1e3;framesPerUpdate=10;updatesPerFrame=1;frame=0;onTorus=!1;currentFramebuffer="0";pauseUpdating=!0;constructor({canvas}){super(canvas);var e=this.createHiddenCanvas(),t={shaders:{noUpdate:`
		...
		`},uniforms:{noUpdate:{stepSize:1/this.gridSize},update:{stepSize:1/this.gridSize,onTorus:this.onTorus?1:0}},canvasWidth:this.resolution,verbose:window.DEBUG},e=(this.wilsonHidden=new WilsonGL(e,t),{shader:`
			precision highp float;
			precision highp sampler2D;
