import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{sleep}from"/scripts/src/utils.min.js";import{WilsonGL}from"/scripts/wilson.min.js";class GameOfLife extends AnimationFrameApplet{wilsonUpscale;gridSize=100;resolution=1e3;framesPerUpdate=10;updatesPerFrame=1;frame=0;onTorus=!1;currentFramebuffer="0";pauseUpdating=!0;constructor({canvas}){super(canvas);var e=this.createHiddenCanvas(),t={shaders:{noUpdate:`
