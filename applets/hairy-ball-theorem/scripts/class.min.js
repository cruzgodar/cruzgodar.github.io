import{VectorField}from"/applets/vector-fields/scripts/class.min.js";import{Applet}from"/scripts/applets/applet.min.js";import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";import{addTemporaryListener,pageElement}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";class HairyBall extends RaymarchApplet{theta=Math.PI;phi=Math.PI/2;lockedOnOrigin=!0;distanceFromOrigin=1.55;cameraPos=[this.distanceFromOrigin,0,0];vectorFieldAppletResolution;vectorFieldDilation=1;vectorFieldApplet;constructor({canvas,vectorFieldAppletResolution=500,vectorFieldDilation=1}){super(canvas),this.vectorFieldAppletResolution=vectorFieldAppletResolution,this.vectorFieldDilation=vectorFieldDilation;var i=this.createHiddenCanvas(),i=(i.style.display="block",i.classList.remove("hidden-canvas"),i.classList.add("output-canvas"),pageElement.appendChild(i),this.vectorFieldApplet=new VectorField({canvas:i,loopEdges:!1}),this.vectorFieldApplet.drawFrameCallback=this.drawFrame.bind(this),this.vectorFieldApplet.loadPromise.then(()=>{this.runVectorField()}),{renderer:"gpu",shader:`
