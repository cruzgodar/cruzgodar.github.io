import{getGlslBundle,loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{tempShader}from"/scripts/applets/applet.min.js";import{siteSettings}from"/scripts/src/settings.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class GeneralizedJuliaSets extends AnimationFrameApplet{loadPromise;generatingCode="cadd(cpow(z, 2.0), c)";wilsonHidden;switchJuliaModeButton;juliaMode="mandelbrot";pastBrightnessScales=[];numIterations=200;c=[0,0];resolution=1e3;resolutionHidden=50;constructor({canvas,switchJuliaModeButton}){super(canvas),this.switchJuliaModeButton=switchJuliaModeButton;var e=this.createHiddenCanvas(),i={shader:tempShader,canvasWidth:this.resolution,worldWidth:4,worldHeight:4,worldCenterX:0,worldCenterY:0,minWorldWidth:1e-5,maxWorldWidth:100,minWorldHeight:1e-5,maxWorldHeight:100,onResizeCanvas:()=>this.needNewFrame=!0,reduceMotion:siteSettings.reduceMotion,draggableOptions:{draggables:{draggableArg:[0,0]},callbacks:{drag:this.onDragDraggable.bind(this)}},interactionOptions:{useForPanAndZoom:!0,onPanAndZoom:()=>this.needNewFrame=!0,callbacks:{mousemove:this.onMousemove.bind(this),mousedown:this.onMousedown.bind(this),touchmove:this.onTouchmove.bind(this),touchend:this.onTouchend.bind(this)}},fullscreenOptions:{fillScreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"}};this.wilson=new WilsonGPU(canvas,i),this.wilsonHidden=new WilsonGPU(e,{...i,draggableOptions:{},canvasWidth:this.resolutionHidden}),this.wilson.draggables.draggableArg.element.style.display="none",this.loadPromise=loadGlsl()}run({generatingCode="cpow(z, 2.0) + c",resolution=500}){this.generatingCode=generatingCode,this.resolution=resolution;var e=-1!==generatingCode.indexOf("draggableArg"),i=`
