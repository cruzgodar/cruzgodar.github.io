import{Applet}from"/scripts/src/applets.mjs";class Snowflake extends Applet{loadPromise=null;resolution=500;lastTimestamp=-1;computationsPerFrame=20;constructor(e){super(e);var t={renderer:"gpu",shader:`
