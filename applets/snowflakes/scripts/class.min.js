import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{Wilson}from"/scripts/wilson.min.js";class Snowflake extends AnimationFrameApplet{loadPromise=null;resolution=500;computationsPerFrame=20;constructor({canvas}){super(canvas);var e={renderer:"gpu",shader:`
