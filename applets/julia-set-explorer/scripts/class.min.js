import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{getFloatGlsl,getVectorGlsl,tempShader}from"/scripts/applets/applet.min.js";import{changeOpacity}from"/scripts/src/animation.min.js";import{getGlslBundle,loadGlsl}from"/scripts/src/complexGlsl.min.js";import{currentlyTouchDevice}from"/scripts/src/interaction.min.js";import{animate,sleep}from"/scripts/src/utils.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";const bubbleRadius=1;class JuliaSetExplorer extends AnimationFrameApplet{wilsonPreview;wilsonHidden;generatingCode;worldAdjust;maxWorldSize;needDraggable;bailoutRadius;juliaMode="mandelbrot";numIterations=500;hasRun=!1;switchJuliaModeButton;ignoreBrightnessCalculation=!1;pastBrightnessScales=[];c=[0,0];resolution;resolutionHidden=50;constructor({canvas,previewCanvas,switchJuliaModeButton,generatingCode,worldAdjust=[0,0],maxWorldSize=4,bailoutRadius=4,juliaMode="mandelbrot",c=[0,0],resolution=1e3}){super(canvas),this.switchJuliaModeButton=switchJuliaModeButton;var i={shader:tempShader,canvasWidth:resolution,worldWidth:4,worldCenterX:0,worldCenterY:0,minWorldX:-maxWorldSize/2,maxWorldX:maxWorldSize/2,minWorldY:-maxWorldSize/2,maxWorldY:maxWorldSize/2,minWorldWidth:1e-5,minWorldHeight:1e-5,useResetButton:!0,resetButtonIconPath:"/graphics/general-icons/reset.png",onResizeCanvas:()=>this.needNewFrame=!0,draggableOptions:{draggables:{draggableArg:[0,0]},callbacks:{drag:this.onDragDraggable.bind(this)}},interactionOptions:{useForPanAndZoom:!0,onPanAndZoom:()=>this.needNewFrame=!0,callbacks:{mousemove:this.onMousemove.bind(this),mousedown:this.onMousedown.bind(this),touchstart:this.onTouchstart.bind(this),touchmove:this.onTouchmove.bind(this),touchend:this.onTouchend.bind(this)}},fullscreenOptions:{onSwitch:this.switchFullscreen.bind(this),beforeSwitch:this.beforeSwitchFullscreen.bind(this),fillScreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"},verbose:window.DEBUG},e=(this.wilson=new WilsonGPU(canvas,i),this.createHiddenCanvas());this.wilsonHidden=new WilsonGPU(e,{...i,canvasWidth:this.resolutionHidden,draggableOptions:{}}),this.wilsonHidden.createFramebufferTexturePair({id:"draw",textureType:"float"}),this.wilsonHidden.useFramebuffer("draw"),previewCanvas&&(e={shader:tempShader,canvasWidth:Math.ceil(this.resolution/4),worldWidth:3,worldCenterX:-worldAdjust[0],worldCenterY:-worldAdjust[1],verbose:window.DEBUG},this.wilsonPreview=new WilsonGPU(previewCanvas,e),this.wilson.canvas.parentElement.appendChild(this.wilsonPreview.canvas)),this.run({generatingCode:generatingCode,worldAdjust:worldAdjust,maxWorldSize:maxWorldSize,bailoutRadius:bailoutRadius,juliaMode:juliaMode,c:c,resolution:resolution})}async getShaders({oldGeneratingCode,forHiddenCanvas=!1}){await loadGlsl();var i=oldGeneratingCode?"uniform float codeInterpolation;":"",e=oldGeneratingCode?`codeInterpolation * (${this.generatingCode}) + (1.0 - codeInterpolation) * (${oldGeneratingCode})`:this.generatingCode,t=getVectorGlsl(this.worldAdjust),s=getFloatGlsl(this.bailoutRadius),r=getGlslBundle(this.generatingCode+" "+(oldGeneratingCode??"")),o=forHiddenCanvas?"vec3(1.0)":"color";return{mandelbrot:`
			...
			void main(void)
			{
				...
				gl_FragColor = vec4(brightness / brightnessScale * ${o}, 1.0);
			}
		`,juliaPicker:`
			precision highp float;
