import{Applet}from"../../../scripts/applets/applet.min.js";import{doubleEmulationGlsl,loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import{addTemporaryListener}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";class JuliaSet extends Applet{wilsonHidden=null;juliaMode=0;aspectRatio=1;numIterations=100;useDoublePrecision=!1;doublePrecision=!1;switchJuliaModeButton=null;doublePrecisionZoomThreshhold=-16;pastBrightnessScales=[];a=0;b=1;resolution=1e3;resolutionHidden=100;constructor({canvas,switchJuliaModeButton}){super(canvas),this.pan.minX=-2.75,this.pan.maxX=1.25,this.pan.minY=-2,this.pan.maxY=2,this.switchJuliaModeButton=switchJuliaModeButton,loadGlsl().then(()=>this.run({canvas:canvas}))}run({canvas}){var e=`
