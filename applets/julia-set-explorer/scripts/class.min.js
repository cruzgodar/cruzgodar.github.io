import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{currentlyTouchDevice}from"/scripts/src/interaction.min.js";import{animate,sleep}from"/scripts/src/utils.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";const bubbleRadius=1;function getShaders(forHiddenCanvas=!1){var i=forHiddenCanvas?"vec3(1.0)":"color";return{mandelbrot:`
		...
		void main(void)
		{
			...
			gl_FragColor = vec4(brightness / brightnessScale * ${i}, 1.0);
		}
	`,juliaPicker:`
		precision highp float;
