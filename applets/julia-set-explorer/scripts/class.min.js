import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{getFloatGlsl,getVectorGlsl,tempShader}from"/scripts/applets/applet.min.js";import{getGlslBundle,loadGlsl}from"/scripts/src/complexGlsl.min.js";import{currentlyTouchDevice}from"/scripts/src/interaction.min.js";import{animate,sleep}from"/scripts/src/utils.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";const bubbleRadius=1;class JuliaSetExplorer extends AnimationFrameApplet{wilsonHidden;generatingCode;worldAdjust;maxWorldSize;needDraggable;bailoutRadius;juliaMode="mandelbrot";numIterations=1e3;switchJuliaModeButton;ignoreBrightnessCalculation=!1;pastBrightnessScales=[];c=[0,0];resolution=1e3;resolutionHidden=50;constructor({canvas,switchJuliaModeButton,generatingCode,worldAdjust=[0,0],maxWorldSize=4,bailoutRadius=4}){super(canvas),this.switchJuliaModeButton=switchJuliaModeButton;var i={shader:tempShader,canvasWidth:this.resolution,worldWidth:4,worldCenterX:0,worldCenterY:0,minWorldX:-2,maxWorldX:2,minWorldY:-2,maxWorldY:2,minWorldWidth:1e-5,minWorldHeight:1e-5,useResetButton:!0,resetButtonIconPath:"/graphics/general-icons/reset.png",onResizeCanvas:()=>this.needNewFrame=!0,interactionOptions:{useForPanAndZoom:!0,onPanAndZoom:()=>this.needNewFrame=!0,callbacks:{mousemove:this.onMousemove.bind(this),mousedown:this.onMousedown.bind(this),touchstart:this.onTouchstart.bind(this),touchmove:this.onTouchmove.bind(this),touchend:this.onTouchend.bind(this)}},fullscreenOptions:{onSwitch:this.switchFullscreen.bind(this),beforeSwitch:this.beforeSwitchFullscreen.bind(this),fillScreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"},verbose:window.DEBUG},e=(this.wilson=new WilsonGPU(canvas,i),this.createHiddenCanvas());this.wilsonHidden=new WilsonGPU(e,{...i,canvasWidth:this.resolutionHidden}),this.wilsonHidden.createFramebufferTexturePair({id:"draw",textureType:"float"}),this.wilsonHidden.useFramebuffer("draw"),this.run({generatingCode:generatingCode,worldAdjust:worldAdjust,maxWorldSize:maxWorldSize,bailoutRadius:bailoutRadius})}async getShaders(forHiddenCanvas=!1){await loadGlsl();var i=this.needDraggable?"uniform vec2 draggableArg;":"",e=getVectorGlsl(this.worldAdjust),t=getFloatGlsl(this.bailoutRadius),s=getGlslBundle(this.generatingCode),r=forHiddenCanvas?"vec3(1.0)":"color";return{mandelbrot:`
