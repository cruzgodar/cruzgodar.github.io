import{loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import{Applet}from"/scripts/applets/applet.min.js";import{siteSettings}from"/scripts/src/settings.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class JuliaSet extends Applet{wilsonHidden;juliaMode="mandelbrot";numIterations=100;switchJuliaModeButton;pastBrightnessScales=[];c=[0,0];resolution=1e3;resolutionHidden=50;constructor({canvas,switchJuliaModeButton}){super(canvas),this.switchJuliaModeButton=switchJuliaModeButton,loadGlsl().then(()=>this.run({canvas:canvas}))}run({canvas}){var e={shaders:{mandelbrot:`
