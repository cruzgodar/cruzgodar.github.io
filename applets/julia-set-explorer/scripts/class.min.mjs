import{changeOpacity}from"/scripts/src/animation.min.mjs";import{Applet}from"/scripts/src/applets.min.mjs";import{doubleEmulationGlsl,loadGlsl}from"/scripts/src/complex-glsl.min.mjs";import{addTemporaryListener}from"/scripts/src/main.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class JuliaSet extends Applet{wilsonHidden=null;juliaMode=0;aspectRatio=1;numIterations=100;useDoublePrecision=!1;doublePrecision=!1;switchJuliaModeButtonElement=null;doublePrecisionZoomThreshhold=-16;pastBrightnessScales=[];a=0;b=1;resolution=1e3;resolutionHidden=100;lastTimestamp=-1;constructor(canvas,switchJuliaModeButtonElement=null){super(canvas),this.pan.minX=-2.75,this.pan.maxX=1.25,this.pan.minY=-2,this.pan.maxY=2,this.switchJuliaModeButtonElement=switchJuliaModeButtonElement,loadGlsl().then(()=>this.run({canvas:canvas}))}run({canvas}){var fragShaderSourceSingle0=`
		...
		`,options={renderer:"gpu",shader:fragShaderSourceSingle0,canvasWidth:1e3,canvasHeight:1e3,worldWidth:4,worldHeight:4,worldCenterX:-.75,worldCenterY:0,useFullscreen:!0,trueFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png",switchFullscreenCallback:()=>this.changeAspectRatio(!0),mousedownCallback:this.onGrabCanvas.bind(this),touchstartCallback:this.onGrabCanvas.bind(this),mousemoveCallback:this.onHoverCanvas.bind(this),mousedragCallback:this.onDragCanvas.bind(this),touchmoveCallback:this.onDragCanvas.bind(this),mouseupCallback:this.onReleaseCanvas.bind(this),touchendCallback:this.onReleaseCanvas.bind(this),wheelCallback:this.onWheelCanvas.bind(this),pinchCallback:this.onPinchCanvas.bind(this)},fragShaderSourceSingle0={renderer:"gpu",shader:fragShaderSourceSingle0,canvasWidth:100,canvasHeight:100};this.wilson=new Wilson(canvas,options),this.wilson.render.loadNewShader(fragShaderSourceSingle1),this.wilson.render.loadNewShader(fragShaderSourceSingle2),this.wilson.render.loadNewShader(fragShaderSourceDouble0),this.wilson.render.loadNewShader(fragShaderSourceDouble1),this.wilson.render.loadNewShader(fragShaderSourceDouble2);for(let i=0;i<6;i++)this.wilson.render.initUniforms(["aspectRatio","worldCenterX","worldCenterY","worldSize","a","b","numIterations","brightnessScale"],i);canvas=this.createHiddenCanvas();this.wilsonHidden=new Wilson(canvas,fragShaderSourceSingle0),this.wilsonHidden.render.loadNewShader(fragShaderSourceSingle1),this.wilsonHidden.render.loadNewShader(fragShaderSourceSingle2),this.wilsonHidden.render.loadNewShader(fragShaderSourceDouble0),this.wilsonHidden.render.loadNewShader(fragShaderSourceDouble1),this.wilsonHidden.render.loadNewShader(fragShaderSourceDouble2);for(let i=0;i<6;i++)this.wilsonHidden.render.initUniforms(["aspectRatio","worldCenterX","worldCenterY","worldSize","a","b","numIterations","brightnessScale"],i);this.zoom.init(),window.requestAnimationFrame(this.drawFrame.bind(this));addTemporaryListener({object:window,event:"resize",callback:()=>this.changeAspectRatio(!0)})}toggleUseDoublePrecision(){this.useDoublePrecision=!this.useDoublePrecision,this.zoomCanvas()}toggleDoublePrecision(){this.doublePrecision=!this.doublePrecision,this.doublePrecision?this.wilson.canvas.style.borderColor="rgb(127, 0, 0)":this.wilson.canvas.style.borderColor="rgb(127, 127, 127)"}advanceJuliaMode(){0===this.juliaMode?(this.juliaMode=2,this.a=0,this.b=0,this.pastBrightnessScales=[],this.switchJuliaModeButtonElement&&changeOpacity(this.switchJuliaModeButtonElement,0).then(()=>{this.switchJuliaModeButtonElement.textContent="Return to Mandelbrot"})):1===this.juliaMode&&(this.juliaMode=0,this.wilson.worldCenterX=-.75,this.wilson.worldCenterY=0,this.wilson.worldWidth=4,this.wilson.worldHeight=4,this.pan.minX=-2.75,this.pan.maxX=1.25,this.pan.minY=-2,this.pan.maxY=2,this.zoom.init(),this.pastBrightnessScales=[],this.switchJuliaModeButtonElement)&&changeOpacity(this.switchJuliaModeButtonElement,0).then(()=>{this.switchJuliaModeButtonElement.textContent="Pick Julia Set",changeOpacity(this.switchJuliaModeButtonElement,1)})}onGrabCanvas(x,y,event){this.pan.onGrabCanvas(),this.zoom.onGrabCanvas(),2===this.juliaMode&&"mousedown"===event.type&&(this.juliaMode=1,this.wilson.worldCenterX=0,this.wilson.worldCenterY=0,this.wilson.worldWidth=4,this.wilson.worldHeight=4,this.pan.minX=-2,this.pan.maxX=2,this.pan.minY=-2,this.pan.maxY=2,this.zoom.init(),this.pastBrightnessScales=[],this.switchJuliaModeButtonElement)&&changeOpacity(this.switchJuliaModeButtonElement,1)}onDragCanvas(x,y,xDelta,yDelta,event){2===this.juliaMode&&"touchmove"===event.type?(this.a=x,this.b=y):this.pan.onDragCanvas(x,y,xDelta,yDelta)}onHoverCanvas(x,y,xDelta,yDelta,event){2===this.juliaMode&&"mousemove"===event.type&&(this.a=x,this.b=y)}onReleaseCanvas(x,y,event){2===this.juliaMode&&"touchend"===event.type?(this.juliaMode=1,this.wilson.worldCenterX=0,this.wilson.worldCenterY=0,this.wilson.worldWidth=4,this.wilson.worldHeight=4,this.pan.minX=-2,this.pan.maxX=2,this.pan.minY=-2,this.pan.maxY=2,this.zoom.init(),this.pastBrightnessScales=[],this.switchJuliaModeButtonElement&&changeOpacity(this.switchJuliaModeButtonElement,1)):(this.pan.onReleaseCanvas(),this.zoom.onReleaseCanvas())}onWheelCanvas(x,y,scrollAmount){2!==this.juliaMode&&this.zoom.onWheelCanvas(x,y,scrollAmount)}onPinchCanvas(x,y,touchDistanceDelta){2!==this.juliaMode&&this.zoom.onPinchCanvas(x,y,touchDistanceDelta)}drawFrame(timestamp){var timeElapsed=timestamp-this.lastTimestamp;if(this.lastTimestamp=timestamp,0!=timeElapsed){this.pan.update(),this.zoom.update(),(!this.doublePrecision&&this.zoom.level<this.doublePrecisionZoomThreshhold&&this.useDoublePrecision||this.doublePrecision&&(this.zoom.level>this.doublePrecisionZoomThreshhold||!this.useDoublePrecision))&&this.toggleDoublePrecision();var timestamp=Applet.doubleToDf(this.wilson.worldCenterX),timeElapsed=Applet.doubleToDf(this.wilson.worldCenterY),shaderProgramIndex=this.juliaMode+3*this.doublePrecision,pixelData=(this.numIterations=30*-this.zoom.level+200,this.wilsonHidden.gl.useProgram(this.wilsonHidden.render.shaderPrograms[shaderProgramIndex]),this.wilsonHidden.gl.uniform1f(this.wilsonHidden.uniforms.aspectRatio[shaderProgramIndex],1),this.wilsonHidden.gl.uniform2fv(this.wilsonHidden.uniforms.worldCenterX[shaderProgramIndex],timestamp),this.wilsonHidden.gl.uniform2fv(this.wilsonHidden.uniforms.worldCenterY[shaderProgramIndex],timeElapsed),this.wilsonHidden.gl.uniform1f(this.wilsonHidden.uniforms.worldSize[shaderProgramIndex],Math.min(this.wilson.worldHeight,this.wilson.worldWidth)/2),this.wilsonHidden.gl.uniform1i(this.wilsonHidden.uniforms.numIterations[shaderProgramIndex],this.numIterations),this.wilsonHidden.gl.uniform1f(this.wilsonHidden.uniforms.a[shaderProgramIndex],this.a),this.wilsonHidden.gl.uniform1f(this.wilsonHidden.uniforms.b[shaderProgramIndex],this.b),this.wilsonHidden.gl.uniform1f(this.wilsonHidden.uniforms.brightnessScale[shaderProgramIndex],20*(Math.abs(this.zoom.level)+1)),this.wilsonHidden.render.drawFrame(),this.wilsonHidden.render.getPixelData()),brightnesses=new Array(this.resolutionHidden*this.resolutionHidden);for(let i=0;i<this.resolutionHidden*this.resolutionHidden;i++)brightnesses[i]=pixelData[4*i]+pixelData[4*i+1]+pixelData[4*i+2];brightnesses.sort((a,b)=>a-b);var brightnessScale=(brightnesses[Math.floor(this.resolutionHidden*this.resolutionHidden*.96)]+brightnesses[Math.floor(this.resolutionHidden*this.resolutionHidden*.98)])/255*15*(Math.abs(this.zoom.level/2)+1),denom=(this.pastBrightnessScales.push(brightnessScale),this.pastBrightnessScales.length);10<denom&&this.pastBrightnessScales.shift(),brightnessScale=Math.max(this.pastBrightnessScales.reduce((a,b)=>a+b)/denom,.5),this.wilson.gl.useProgram(this.wilson.render.shaderPrograms[shaderProgramIndex]),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatio[shaderProgramIndex],this.aspectRatio),this.wilson.gl.uniform2fv(this.wilson.uniforms.worldCenterX[shaderProgramIndex],timestamp),this.wilson.gl.uniform2fv(this.wilson.uniforms.worldCenterY[shaderProgramIndex],timeElapsed),this.wilson.gl.uniform1f(this.wilson.uniforms.worldSize[shaderProgramIndex],Math.min(this.wilson.worldHeight,this.wilson.worldWidth)/2),this.wilson.gl.uniform1i(this.wilson.uniforms.numIterations[shaderProgramIndex],this.numIterations),this.wilson.gl.uniform1f(this.wilson.uniforms.a[shaderProgramIndex],this.a),this.wilson.gl.uniform1f(this.wilson.uniforms.b[shaderProgramIndex],this.b),this.wilson.gl.uniform1f(this.wilson.uniforms.brightnessScale[shaderProgramIndex],brightnessScale),this.wilson.render.drawFrame(),this.animationPaused||window.requestAnimationFrame(this.drawFrame.bind(this))}}}export{JuliaSet};