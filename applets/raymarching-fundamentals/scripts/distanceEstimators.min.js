...
`;function getMengerSpongeDE(useForGetColor=!1){return`
	...
	`],ns={tetrahedron:[[-.57735,0,.816496],[.288675,-.5,.816496],[.288675,.5,.816496]],cube:[[1,0,0],[0,1,0],[0,0,1]],octahedron:[[.707107,0,.707107],[0,.707107,.707107],[-.707107,0,.707107],[0,-.707107,.707107]]},scaleCenters={tetrahedron:[0,0,1],cube:[.57735,.57735,.57735],octahedron:[0,0,1]},maxIterations=56;function getKIFSDistanceEstimator(shape,useForGetColor=!1){var e=shape[0].toUpperCase()+shape.slice(1);return`
	...
	`}const kIFSCubeDE=[getKIFSDistanceEstimator("cube"),getKIFSDistanceEstimator("cube",!0)];export{roomSphereDE,extrudedCubeDE,mengerSpongeDE,kIFSCubeDE};