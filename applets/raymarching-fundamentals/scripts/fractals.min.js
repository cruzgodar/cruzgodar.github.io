import{RaymarchingFundamentals}from"./class.min.js";import{extrudedCubeDE}from"./distanceEstimators.min.js";class Fractals extends RaymarchingFundamentals{constructor({canvas,useShadows=!0,useReflections=!1}){var t=`
		...
		`;console.log(t),super({canvas:canvas,fragShaderSource:t,uniforms:["extrudedCubeSeparation","extrudedCubeWeight"]}),this.wilson.gl.uniform1f(this.wilson.uniforms.extrudedCubeWeight,1),this.wilson.gl.uniform1f(this.wilson.uniforms.extrudedCubeSeparation,2)}}export{Fractals};