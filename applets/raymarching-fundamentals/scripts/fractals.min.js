import{RaymarchingFundamentals}from"./class.min.js";import{extrudedCubeDE}from"./distanceEstimators.min.js";class Fractals extends RaymarchingFundamentals{constructor({canvas}){var t=`
		...
		`;console.log(t),super({canvas:canvas,fragShaderSource:t,uniforms:["shadowAmount","reflectivityAmount","extrudedCubeSeparation","extrudedCubeWeight"]}),this.wilson.gl.uniform1f(this.wilson.uniforms.shadowAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.reflectivityAmount,0),this.wilson.gl.uniform1f(this.wilson.uniforms.extrudedCubeWeight,1),this.wilson.gl.uniform1f(this.wilson.uniforms.extrudedCubeSeparation,2)}}export{Fractals};