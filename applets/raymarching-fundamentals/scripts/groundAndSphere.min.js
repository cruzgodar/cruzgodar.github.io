import{RaymarchingFundamentals}from"./class.min.js";import{extrudedCubeDE}from"./distanceEstimators.min.js";import{getMinGlslString}from"/scripts/applets/applet.min.js";class GroundAndSphere extends RaymarchingFundamentals{constructor({canvas}){var o=`
		...
		`;console.log(o),super({canvas:canvas,fragShaderSource:o,uniforms:["showSphereAmount","groundTextureAmount","fogAmount","ambientOcclusionAmount","pointLightAmount","ambientLightAmount","shadowAmount","softShadowAmount","reflectivityAmount","showRoomsAmount","modPosAmount","extrudedCubeSeparation"]}),this.wilson.gl.uniform1f(this.wilson.uniforms.showSphereAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.groundTextureAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.fogAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.ambientOcclusionAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.pointLightAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.ambientLightAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.shadowAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.softShadowAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.reflectivityAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.showRoomsAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.modPosAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.extrudedCubeSeparation,1)}}export{GroundAndSphere};