import{extrudedCubeDE,roomSphereDE}from"./distanceEstimators.min.js";import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";class GroundAndSphere extends RaymarchApplet{constructor({canvas}){super({canvas:canvas,shader:`
		...
		`,uniforms:{showSphereAmount:["float",0],lightAmount:["float",0],ambientOcclusionAmount:["float",0],groundTextureAmount:["float",0],fogAmount:["float",0],pointLightAmount:["float",0],shadowAmount:["float",0],softShadowAmount:["float",0],reflectivityAmount:["float",0],modPosAmount:["float",0],showRoomsAmount:["float",0],sphereWeight:["float",1],extrudedCubeWeight:["float",0],extrudedCubeSeparation:["float",1.5]},cameraPos:[-.6568,1.2449,1],theta:-1.2209,phi:1.7904,fogScaling:.075,lockedOnOrigin:!1,lockZ:1})}distanceEstimator(){return 1}}export{GroundAndSphere};