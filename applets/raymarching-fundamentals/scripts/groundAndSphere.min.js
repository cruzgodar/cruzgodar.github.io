import{extrudedCubeDE,roomSphereDE}from"./distanceEstimators.min.js";import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";class GroundAndSphere extends RaymarchApplet{constructor({canvas}){super({canvas:canvas,shader:`
		...
		`,uniforms:{showSphereAmount:["float",1],groundTextureAmount:["float",1],fogAmount:["float",1],pointLightAmount:["float",1],ambientLightAmount:["float",1],shadowAmount:["float",0],softShadowAmount:["float",1],reflectivityAmount:["float",0],modPosAmount:["float",1],showRoomsAmount:["float",1],sphereWeight:["float",0],extrudedCubeWeight:["float",1],extrudedCubeSeparation:["float",1.5]},cameraPos:[-.6568,1.2449,1],theta:-1.2209,phi:1.7904,fogScaling:.075,lockedOnOrigin:!1,lockZ:1})}distanceEstimator(){return 1}}export{GroundAndSphere};