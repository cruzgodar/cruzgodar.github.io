import{extrudedCubeDE,roomSphereDE}from"./distanceEstimators.min.js";import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";class GroundAndSphere extends RaymarchApplet{constructor({canvas}){super({canvas:canvas,shader:`
		...
		`,uniforms:{showSphereAmount:0,lightAmount:0,ambientOcclusionAmount:0,groundTextureAmount:0,fogAmount:0,pointLightAmount:0,shadowAmount:0,softShadowAmount:0,reflectivityAmount:0,modPosAmount:0,showRoomsAmount:0,sphereWeight:1,extrudedCubeWeight:0,extrudedCubeSeparation:1.5},cameraPos:[-.6568,1.2449,1],theta:-1.2209,phi:1.7904,fogScaling:.075,lockedOnOrigin:!1,lockZ:1})}distanceEstimator(){return 1}}export{GroundAndSphere};