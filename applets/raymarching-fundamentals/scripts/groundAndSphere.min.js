import{RaymarchingFundamentals}from"./class.min.js";import{getMinGlslString}from"/scripts/applets/applet.min.js";class GroundAndSphere extends RaymarchingFundamentals{constructor({canvas}){var t=`
		...
		`;console.log(t),super({canvas:canvas,fragShaderSource:t,uniforms:["showSphereAmount","groundTextureAmount","fogAmount","ambientOcclusionAmount","pointLightAmount","ambientLightAmount","shadowAmount","softShadowAmount","reflectivityAmount"]}),this.wilson.gl.uniform1f(this.wilson.uniforms.showSphereAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.groundTextureAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.fogAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.ambientOcclusionAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.pointLightAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.ambientLightAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.shadowAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.softShadowAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.reflectivityAmount,1)}}export{GroundAndSphere};