import{RaymarchingFundamentals}from"./class.min.js";import{getMinGlslString}from"/scripts/applets/applet.min.js";class GroundAndSphere extends RaymarchingFundamentals{constructor({canvas}){super({canvas:canvas,fragShaderSource:`
		...
		`,uniforms:["showSphereAmount","groundTextureAmount","fogAmount","ambientOcclusionAmount","pointLightAmount","ambientLightAmount","shadowAmount"]}),this.wilson.gl.uniform1f(this.wilson.uniforms.showSphereAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.groundTextureAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.fogAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.ambientOcclusionAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.pointLightAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.ambientLightAmount,1),this.wilson.gl.uniform1f(this.wilson.uniforms.shadowAmount,1)}}export{GroundAndSphere};