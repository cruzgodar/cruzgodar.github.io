"use strict";class KaleidoscopicIFSFractal extends Applet{currentlyDrawing=!1;currentlyAnimatingParameters=!1;currentlyDragging=!1;drawStartTime=0;mouseX=0;mouseY=0;movingForwardKeyboard=!1;movingBackwardKeyboard=!1;movingRightKeyboard=!1;movingLeftKeyboard=!1;movingForwardTouch=!1;movingBackwardTouch=!1;wasMovingTouch=!1;movingSpeed=0;nextMoveVelocity=[0,0,0];moveVelocity=[0,0,0];moveFriction=.94;moveVelocityStopThreshhold=5e-4;distanceToScene=1;lastTimestamp=-1;theta=3.2954;phi=1.9657;nextThetaVelocity=0;nextPhiVelocity=0;thetaVelocity=0;phiVelocity=0;panFriction=.94;panVelocityStartThreshhold=.005;panVelocityStopThreshhold=5e-4;imageSize=500;imageWidth=500;imageHeight=500;numSierpinskiIterations=24;scale=2;imagePlaneCenterPos=[];forwardVec=[];rightVec=[];upVec=[];cameraPos=[2.1089,.41345,.95325];polyhedronIndex=0;focalLength=2;lightPos=[[0,0,5],[5,5,5],[0,0,5]];n1=[[-.57735,0,.816496],[1,0,0],[.707107,0,.707107]];n2=[[.288675,-.5,.816496],[0,1,0],[0,.707107,.707107]];n3=[[.288675,.5,.816496],[0,0,1],[-.707107,0,.707107]];n4=[[],[],[0,-.707107,.707107]];numNs=[3,3,4];scaleCenter=[[0,0,1],[.57735,.57735,.57735],[0,0,1]];rotationAngleX1=0;rotationAngleY1=0;rotationAngleZ1=0;rotationAngleX2=0;rotationAngleY2=0;rotationAngleZ2=0;rotationAngleX1Old=0;rotationAngleY1Old=0;rotationAngleZ1Old=0;rotationAngleX2Old=0;rotationAngleY2Old=0;rotationAngleZ2Old=0;rotationAngleX1Delta=0;rotationAngleY1Delta=0;rotationAngleZ1Delta=0;rotationAngleX2Delta=0;rotationAngleY2Delta=0;rotationAngleZ2Delta=0;parameterAnimationFrame=0;constructor(t){super(t);let i=`
  ...
  `,e={renderer:"gpu",shader:i,canvasWidth:500,canvasHeight:500,useFullscreen:!0,trueFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png",switchFullscreenCallback:this.changeResolution.bind(this),mousedownCallback:this.onGrabCanvas.bind(this),touchstartCallback:this.onGrabCanvas.bind(this),mousedragCallback:this.onDragCanvas.bind(this),touchmoveCallback:this.onDragCanvas.bind(this),mouseupCallback:this.onReleaseCanvas.bind(this),touchendCallback:this.onReleaseCanvas.bind(this)};this.wilson=new Wilson(t,e),this.wilson.render.initUniforms(["aspectRatioX","aspectRatioY","imageSize","cameraPos","imagePlaneCenterPos","forwardVec","rightVec","upVec","focalLength","lightPos","scaleCenter","n1","n2","n3","n4","numNs","rotationMatrix1","rotationMatrix2"]),this.calculateVectors(),this.imageWidth>=this.imageHeight?(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,this.imageWidth/this.imageHeight),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,1)):(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,1),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,this.imageWidth/this.imageHeight)),this.wilson.gl.uniform1i(this.wilson.uniforms.imageSize,this.imageSize),this.wilson.gl.uniform3fv(this.wilson.uniforms.cameraPos,this.cameraPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.imagePlaneCenterPos,this.imagePlaneCenterPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.lightPos,this.lightPos[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.scaleCenter,this.scaleCenter[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.forwardVec,this.forwardVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.rightVec,this.rightVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.upVec,this.upVec),this.wilson.gl.uniform1f(this.wilson.uniforms.focalLength,this.focalLength),this.wilson.gl.uniform3fv(this.wilson.uniforms.n1,this.n1[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n2,this.n2[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n3,this.n3[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n4,this.n4[this.polyhedronIndex]),this.wilson.gl.uniform1i(this.wilson.uniforms.numNs,this.numNs[this.polyhedronIndex]),this.wilson.gl.uniformMatrix3fv(this.wilson.uniforms.rotationMatrix1,!1,[1,0,0,0,1,0,0,0,1]),this.wilson.gl.uniformMatrix3fv(this.wilson.uniforms.rotationMatrix2,!1,[1,0,0,0,1,0,0,0,1]);let o=this.handleKeydownEvent.bind(this);document.documentElement.addEventListener("keydown",o),this.handlers.push([document.documentElement,"keydown",o]);let s=this.handleKeyupEvent.bind(this);document.documentElement.addEventListener("keyup",s),this.handlers.push([document.documentElement,"keyup",s]);let n=()=>{this.changeResolution()};window.addEventListener("resize",n),this.handlers.push([window,"resize",n]),window.requestAnimationFrame(this.drawFrame.bind(this))}drawFrame(t){let i=t-this.lastTimestamp;if(this.lastTimestamp=t,0===i)return;this.wilson.render.drawFrame();let e=!1;this.movingForwardKeyboard||this.movingBackwardKeyboard||this.movingRightKeyboard||this.movingLeftKeyboard||this.movingForwardTouch||this.movingBackwardTouch?(this.updateCameraParameters(),e=!0):i>=50&&(this.nextThetaVelocity=0,this.nextPhiVelocity=0,this.thetaVelocity=0,this.phiVelocity=0,this.movingForwardTouch=!1,this.movingBackwardTouch=!1,this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0,this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0),(0!==this.thetaVelocity||0!==this.phiVelocity)&&(this.theta+=this.thetaVelocity,this.phi+=this.phiVelocity,this.theta>=2*Math.PI?this.theta-=2*Math.PI:this.theta<0&&(this.theta+=2*Math.PI),this.phi>Math.PI-.01?this.phi=Math.PI-.01:this.phi<.01&&(this.phi=.01),this.thetaVelocity*=this.panFriction,this.phiVelocity*=this.panFriction,this.thetaVelocity*this.thetaVelocity+this.phiVelocity*this.phiVelocity<this.panVelocityStopThreshhold*this.panVelocityStopThreshhold&&(this.thetaVelocity=0,this.phiVelocity=0),this.calculateVectors(),e=!0),(0!==this.moveVelocity[0]||0!==this.moveVelocity[1]||0!==this.moveVelocity[2])&&(this.cameraPos[0]+=this.moveVelocity[0],this.cameraPos[1]+=this.moveVelocity[1],this.cameraPos[2]+=this.moveVelocity[2],this.moveVelocity[0]*=this.moveFriction,this.moveVelocity[1]*=this.moveFriction,this.moveVelocity[2]*=this.moveFriction,this.moveVelocity[0]*this.moveVelocity[0]+this.moveVelocity[1]*this.moveVelocity[1]+this.moveVelocity[2]*this.moveVelocity[2]<this.moveVelocityStopThreshhold*this.movingSpeed*this.moveVelocityStopThreshhold*this.movingSpeed&&(this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0),this.calculateVectors(),e=!0),e&&window.requestAnimationFrame(this.drawFrame.bind(this))}calculateVectors(){this.forwardVec=[Math.cos(this.theta)*Math.sin(this.phi),Math.sin(this.theta)*Math.sin(this.phi),Math.cos(this.phi)],this.rightVec=this.normalize([this.forwardVec[1],-this.forwardVec[0],0]),this.upVec=this.crossProduct(this.rightVec,this.forwardVec),this.distanceToScene=this.distanceEstimator(this.cameraPos[0],this.cameraPos[1],this.cameraPos[2]),this.focalLength=this.distanceToScene/2,this.rightVec[0]*=this.focalLength/2,this.rightVec[1]*=this.focalLength/2,this.upVec[0]*=this.focalLength/2,this.upVec[1]*=this.focalLength/2,this.upVec[2]*=this.focalLength/2,this.imagePlaneCenterPos=[this.cameraPos[0]+this.focalLength*this.forwardVec[0],this.cameraPos[1]+this.focalLength*this.forwardVec[1],this.cameraPos[2]+this.focalLength*this.forwardVec[2]],this.wilson.gl.uniform3fv(this.wilson.uniforms.cameraPos,this.cameraPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.imagePlaneCenterPos,this.imagePlaneCenterPos),this.wilson.gl.uniform3fv(this.wilson.uniforms.forwardVec,this.forwardVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.rightVec,this.rightVec),this.wilson.gl.uniform3fv(this.wilson.uniforms.upVec,this.upVec),this.wilson.gl.uniform1f(this.wilson.uniforms.focalLength,this.focalLength)}dotProduct(t,i){return t[0]*i[0]+t[1]*i[1]+t[2]*i[2]}crossProduct(t,i){return[t[1]*i[2]-t[2]*i[1],t[2]*i[0]-t[0]*i[2],t[0]*i[1]-t[1]*i[0]]}matMul(t,i){return[[t[0][0]*i[0][0]+t[0][1]*i[1][0]+t[0][2]*i[2][0],t[0][0]*i[0][1]+t[0][1]*i[1][1]+t[0][2]*i[2][1],t[0][0]*i[0][2]+t[0][1]*i[1][2]+t[0][2]*i[2][2]],[t[1][0]*i[0][0]+t[1][1]*i[1][0]+t[1][2]*i[2][0],t[1][0]*i[0][1]+t[1][1]*i[1][1]+t[1][2]*i[2][1],t[1][0]*i[0][2]+t[1][1]*i[1][2]+t[1][2]*i[2][2]],[t[2][0]*i[0][0]+t[2][1]*i[1][0]+t[2][2]*i[2][0],t[2][0]*i[0][1]+t[2][1]*i[1][1]+t[2][2]*i[2][1],t[2][0]*i[0][2]+t[2][1]*i[1][2]+t[2][2]*i[2][2]]]}normalize(t){let i=Math.sqrt(t[0]*t[0]+t[1]*t[1]+t[2]*t[2]);return[t[0]/i,t[1]/i,t[2]/i]}distanceEstimator(t,i,e){for(let o=0;o<this.numSierpinskiIterations;o++){let s=this.dotProduct([t,i,e],this.n1[this.polyhedronIndex]);s<0&&(t-=2*s*this.n1[this.polyhedronIndex][0],i-=2*s*this.n1[this.polyhedronIndex][1],e-=2*s*this.n1[this.polyhedronIndex][2]);let n=this.dotProduct([t,i,e],this.n2[this.polyhedronIndex]);n<0&&(t-=2*n*this.n2[this.polyhedronIndex][0],i-=2*n*this.n2[this.polyhedronIndex][1],e-=2*n*this.n2[this.polyhedronIndex][2]);let a=this.dotProduct([t,i,e],this.n3[this.polyhedronIndex]);if(a<0&&(t-=2*a*this.n3[this.polyhedronIndex][0],i-=2*a*this.n3[this.polyhedronIndex][1],e-=2*a*this.n3[this.polyhedronIndex][2]),this.numNs[this.polyhedronIndex]>=4){let h=this.dotProduct([t,i,e],this.n4[this.polyhedronIndex]);h<0&&(t-=2*h*this.n4[this.polyhedronIndex][0],i-=2*h*this.n4[this.polyhedronIndex][1],e-=2*h*this.n4[this.polyhedronIndex][2])}let r=t,l=i,c=e,$=[[Math.cos(this.rotationAngleZ1),-Math.sin(this.rotationAngleZ1),0],[Math.sin(this.rotationAngleZ1),Math.cos(this.rotationAngleZ1),0],[0,0,1]],m=[[Math.cos(this.rotationAngleY1),0,-Math.sin(this.rotationAngleY1)],[0,1,0],[Math.sin(this.rotationAngleY1),0,Math.cos(this.rotationAngleY1)]],g=[[1,0,0],[0,Math.cos(this.rotationAngleX1),-Math.sin(this.rotationAngleX1)],[0,Math.sin(this.rotationAngleX1),Math.cos(this.rotationAngleX1)]],d=this.matMul(this.matMul($,m),g);t=d[0][0]*r+d[0][1]*l+d[0][2]*c,i=d[1][0]*r+d[1][1]*l+d[1][2]*c,e=d[2][0]*r+d[2][1]*l+d[2][2]*c,t=this.scale*t-(this.scale-1)*this.scaleCenter[this.polyhedronIndex][0],i=this.scale*i-(this.scale-1)*this.scaleCenter[this.polyhedronIndex][1],e=this.scale*e-(this.scale-1)*this.scaleCenter[this.polyhedronIndex][2],r=t,l=i,c=e,$=[[Math.cos(this.rotationAngleZ2),-Math.sin(this.rotationAngleZ2),0],[Math.sin(this.rotationAngleZ2),Math.cos(this.rotationAngleZ2),0],[0,0,1]],m=[[Math.cos(this.rotationAngleY2),0,-Math.sin(this.rotationAngleY2)],[0,1,0],[Math.sin(this.rotationAngleY2),0,Math.cos(this.rotationAngleY2)]],g=[[1,0,0],[0,Math.cos(this.rotationAngleX2),-Math.sin(this.rotationAngleX2)],[0,Math.sin(this.rotationAngleX2),Math.cos(this.rotationAngleX2)]],t=(d=this.matMul(this.matMul($,m),g))[0][0]*r+d[0][1]*l+d[0][2]*c,i=d[1][0]*r+d[1][1]*l+d[1][2]*c,e=d[2][0]*r+d[2][1]*l+d[2][2]*c}return Math.sqrt(t*t+i*i+e*e)*Math.pow(this.scale,-this.numSierpinskiIterations)}onGrabCanvas(t,i,e){this.nextThetaVelocity=0,this.nextPhiVelocity=0,this.thetaVelocity=0,this.phiVelocity=0,"touchstart"===e.type&&(2===e.touches.length?(this.movingForwardTouch=!0,this.movingBackwardTouch=!1,this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0,this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0,window.requestAnimationFrame(this.drawFrame.bind(this))):3===e.touches.length?(this.movingForwardTouch=!1,this.movingBackwardTouch=!0,this.moveVelocity[0]=0,this.moveVelocity[1]=0,this.moveVelocity[2]=0,this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0,window.requestAnimationFrame(this.drawFrame.bind(this))):(this.movingForwardTouch=!1,this.movingBackwardTouch=!1),this.wasMovingTouch=!1)}onDragCanvas(t,i,e,o,s){if("touchmove"===s.type&&this.wasMovingTouch){this.wasMovingTouch=!1;return}this.theta+=e*Math.PI/2,this.nextThetaVelocity=e*Math.PI/2,this.theta>=2*Math.PI?this.theta-=2*Math.PI:this.theta<0&&(this.theta+=2*Math.PI),this.phi+=o*Math.PI/2,this.nextPhiVelocity=o*Math.PI/2,this.phi>Math.PI-.01?this.phi=Math.PI-.01:this.phi<.01&&(this.phi=.01),this.calculateVectors(),window.requestAnimationFrame(this.drawFrame.bind(this))}onReleaseCanvas(t,i,e){"touchend"===e.type&&(this.movingForwardTouch=!1,this.movingBackwardTouch=!1,this.wasMovingTouch=!0,0===this.moveVelocity[0]&&0===this.moveVelocity[1]&&0===this.moveVelocity[2]&&(this.moveVelocity[0]=this.nextMoveVelocity[0],this.moveVelocity[1]=this.nextMoveVelocity[1],this.moveVelocity[2]=this.nextMoveVelocity[2],this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0)),"touchend"===e.type&&e.touches,(0===length||"mouseup"===e.type)&&this.nextThetaVelocity*this.nextThetaVelocity+this.nextPhiVelocity*this.nextPhiVelocity>=this.panVelocityStartThreshhold*this.panVelocityStartThreshhold&&(this.thetaVelocity=this.nextThetaVelocity,this.phiVelocity=this.nextPhiVelocity)}handleKeydownEvent(t){"INPUT"!==document.activeElement.tagName&&(87===t.keyCode||83===t.keyCode||68===t.keyCode||65===t.keyCode)&&(this.nextMoveVelocity=[0,0,0],this.moveVelocity=[0,0,0],87===t.keyCode?this.movingForwardKeyboard=!0:83===t.keyCode&&(this.movingBackwardKeyboard=!0),68===t.keyCode?this.movingRightKeyboard=!0:65===t.keyCode&&(this.movingLeftKeyboard=!0),window.requestAnimationFrame(this.drawFrame.bind(this)))}handleKeyupEvent(t){"INPUT"!==document.activeElement.tagName&&(87===t.keyCode||83===t.keyCode||68===t.keyCode||65===t.keyCode)&&(0===this.moveVelocity[0]&&0===this.moveVelocity[1]&&0===this.moveVelocity[2]&&(this.moveVelocity[0]=this.nextMoveVelocity[0],this.moveVelocity[1]=this.nextMoveVelocity[1],this.moveVelocity[2]=this.nextMoveVelocity[2],this.nextMoveVelocity[0]=0,this.nextMoveVelocity[1]=0,this.nextMoveVelocity[2]=0),87===t.keyCode?this.movingForwardKeyboard=!1:83===t.keyCode&&(this.movingBackwardKeyboard=!1),68===t.keyCode?this.movingRightKeyboard=!1:65===t.keyCode&&(this.movingLeftKeyboard=!1))}updateCameraParameters(){this.movingSpeed=Math.min(Math.max(1e-6,this.distanceToScene/20),.02);let t=[...this.cameraPos];this.movingForwardKeyboard||this.movingForwardTouch?(this.cameraPos[0]+=this.movingSpeed*this.forwardVec[0],this.cameraPos[1]+=this.movingSpeed*this.forwardVec[1],this.cameraPos[2]+=this.movingSpeed*this.forwardVec[2]):(this.movingBackwardKeyboard||this.movingBackwardTouch)&&(this.cameraPos[0]-=this.movingSpeed*this.forwardVec[0],this.cameraPos[1]-=this.movingSpeed*this.forwardVec[1],this.cameraPos[2]-=this.movingSpeed*this.forwardVec[2]),this.movingRightKeyboard?(this.cameraPos[0]+=this.movingSpeed*this.rightVec[0]/this.focalLength,this.cameraPos[1]+=this.movingSpeed*this.rightVec[1]/this.focalLength,this.cameraPos[2]+=this.movingSpeed*this.rightVec[2]/this.focalLength):this.movingLeftKeyboard&&(this.cameraPos[0]-=this.movingSpeed*this.rightVec[0]/this.focalLength,this.cameraPos[1]-=this.movingSpeed*this.rightVec[1]/this.focalLength,this.cameraPos[2]-=this.movingSpeed*this.rightVec[2]/this.focalLength),this.nextMoveVelocity[0]=this.cameraPos[0]-t[0],this.nextMoveVelocity[1]=this.cameraPos[1]-t[1],this.nextMoveVelocity[2]=this.cameraPos[2]-t[2],this.calculateVectors()}changeResolution(t=this.imageSize){this.imageSize=Math.max(100,t),this.wilson.fullscreen.currentlyFullscreen?Page.Layout.aspectRatio>=1?(this.imageWidth=this.imageSize,this.imageHeight=Math.floor(this.imageSize/Page.Layout.aspectRatio)):(this.imageWidth=Math.floor(this.imageSize*Page.Layout.aspectRatio),this.imageHeight=this.imageSize):(this.imageWidth=this.imageSize,this.imageHeight=this.imageSize),this.wilson.changeCanvasSize(this.imageWidth,this.imageHeight),this.imageWidth>=this.imageHeight?(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,this.imageWidth/this.imageHeight),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,1)):(this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioX,1),this.wilson.gl.uniform1f(this.wilson.uniforms.aspectRatioY,this.imageWidth/this.imageHeight)),this.wilson.gl.uniform1i(this.wilson.uniforms.imageSize,this.imageSize),window.requestAnimationFrame(this.drawFrame.bind(this))}updateParameters(t,i,e,o,s,n){anime({targets:this,rotationAngleX1:t,rotationAngleY1:i,rotationAngleZ1:e,rotationAngleX2:o,rotationAngleY2:s,rotationAngleZ2:n,duration:1e3,easing:"easeOutQuad",update:this.updateMatrices.bind(this)})}updateMatrices(){let t=[[Math.cos(this.rotationAngleZ1),-Math.sin(this.rotationAngleZ1),0],[Math.sin(this.rotationAngleZ1),Math.cos(this.rotationAngleZ1),0],[0,0,1]],i=[[Math.cos(this.rotationAngleY1),0,-Math.sin(this.rotationAngleY1)],[0,1,0],[Math.sin(this.rotationAngleY1),0,Math.cos(this.rotationAngleY1)]],e=[[1,0,0],[0,Math.cos(this.rotationAngleX1),-Math.sin(this.rotationAngleX1)],[0,Math.sin(this.rotationAngleX1),Math.cos(this.rotationAngleX1)]],o=this.matMul(this.matMul(t,i),e);this.wilson.gl.uniformMatrix3fv(this.wilson.uniforms.rotationMatrix1,!1,[o[0][0],o[1][0],o[2][0],o[0][1],o[1][1],o[2][1],o[0][2],o[1][2],o[2][2]]),t=[[Math.cos(this.rotationAngleZ2),-Math.sin(this.rotationAngleZ2),0],[Math.sin(this.rotationAngleZ2),Math.cos(this.rotationAngleZ2),0],[0,0,1]],i=[[Math.cos(this.rotationAngleY2),0,-Math.sin(this.rotationAngleY2)],[0,1,0],[Math.sin(this.rotationAngleY2),0,Math.cos(this.rotationAngleY2)]],e=[[1,0,0],[0,Math.cos(this.rotationAngleX2),-Math.sin(this.rotationAngleX2)],[0,Math.sin(this.rotationAngleX2),Math.cos(this.rotationAngleX2)]],o=this.matMul(this.matMul(t,i),e),this.wilson.gl.uniformMatrix3fv(this.wilson.uniforms.rotationMatrix2,!1,[o[0][0],o[1][0],o[2][0],o[0][1],o[1][1],o[2][1],o[0][2],o[1][2],o[2][2]]),window.requestAnimationFrame(this.drawFrame.bind(this))}async changePolyhedron(t){await Page.Animate.changeOpacity(this.wilson.canvas,0,Site.opacityAnimationTime),this.polyhedronIndex=t,this.wilson.gl.uniform3fv(this.wilson.uniforms.lightPos,this.lightPos[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.scaleCenter,this.scaleCenter[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n1,this.n1[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n2,this.n2[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n3,this.n3[this.polyhedronIndex]),this.wilson.gl.uniform3fv(this.wilson.uniforms.n4,this.n4[this.polyhedronIndex]),this.wilson.gl.uniform1i(this.wilson.uniforms.numNs,this.numNs[this.polyhedronIndex]),window.requestAnimationFrame(this.drawFrame.bind(this)),Page.Animate.changeOpacity(this.wilson.canvas,1,Site.opacityAnimationTime)}}