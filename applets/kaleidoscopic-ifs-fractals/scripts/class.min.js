import{getVectorGlsl}from"/scripts/applets/applet.min.js";import{dotProduct,getRotationMatrix,mat3TimesVector,RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";import{changeOpacity}from"/scripts/src/animation.min.js";const ns={tetrahedron:[[-.57735,0,.816496],[.288675,-.5,.816496],[.288675,.5,.816496]],cube:[[1,0,0],[0,1,0],[0,0,1]],octahedron:[[.707107,0,.707107],[0,.707107,.707107],[-.707107,0,.707107],[0,-.707107,.707107]]},scaleCenters={tetrahedron:[0,0,1],cube:[.57735,.57735,.57735],octahedron:[0,0,1]},maxIterations=56;function getDistanceEstimatorGlsl(shape,useForGetColor=!1){var t=shape[0].toUpperCase()+shape.slice(1);return`
	...
	`}class KaleidoscopicIFSFractal extends RaymarchApplet{rotationAngleX=0;rotationAngleY=0;rotationAngleZ=0;shape="octahedron";constructor({canvas,shape="octahedron"}){var t=`
		...
		`;super({canvas:canvas,distanceEstimatorGlsl:getDistanceEstimatorGlsl(shape),getColorGlsl:getDistanceEstimatorGlsl(shape,!0),addGlsl:t,uniforms:{scale:["float",2],rotationMatrix:["mat3",[[1,0,0],[0,1,0],[0,0,1]]]},theta:.2004,phi:1.6538,cameraPos:[-2.03816,-.526988,.30503],lightPos:[-50,-70,100],lightBrightness:1.25,epsilonScaling:.75,stepFactor:.6}),this.shape=shape}distanceEstimator(x,y,z){var t=this.uniforms.scale[1],e=ns[this.shape??"octahedron"],o=scaleCenters[this.shape??"octahedron"],r=this.uniforms.rotationMatrix[1];for(let s=0;s<maxIterations;s++){var a=dotProduct([x,y,z],e[0]),a=(a<0&&(x-=2*a*e[0][0],y-=2*a*e[0][1],z-=2*a*e[0][2]),dotProduct([x,y,z],e[1])),a=(a<0&&(x-=2*a*e[1][0],y-=2*a*e[1][1],z-=2*a*e[1][2]),dotProduct([x,y,z],e[2]));a<0&&(x-=2*a*e[2][0],y-=2*a*e[2][1],z-=2*a*e[2][2]),4<=e.length&&(a=dotProduct([x,y,z],e[3]))<0&&(x-=2*a*e[3][0],y-=2*a*e[3][1],z-=2*a*e[3][2]),x=t*x-(t-1)*o[0],y=t*y-(t-1)*o[1],z=t*z-(t-1)*o[2],[x,y,z]=mat3TimesVector(r,[x,y,z])}return Math.sqrt(x*x+y*y+z*z)*Math.pow(t,-maxIterations)}updateMatrices(){this.setUniform("rotationMatrix",getRotationMatrix(this.rotationAngleX,this.rotationAngleY,this.rotationAngleZ)),this.needNewFrame=!0}async changePolyhedron(newShape){await changeOpacity({element:this.canvas,opacity:0}),this.shape=newShape;var t=getDistanceEstimatorGlsl(this.shape),e=getDistanceEstimatorGlsl(this.shape,!0);this.reloadShader({distanceEstimatorGlsl:t,getColorGlsl:e}),await changeOpacity({element:this.canvas,opacity:1})}}export{KaleidoscopicIFSFractal};