import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{tempShader}from"/scripts/applets/applet.min.js";import{sleep}from"/scripts/src/main.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class LyapunovFractals extends AnimationFrameApplet{wilsonHidden;numIterations=100;pastBrightnessScales=[];resolution=500;resolutionHidden=50;constructor({canvas}){super(canvas);var e=this.createHiddenCanvas(),i={shader:tempShader,canvasWidth:500,worldWidth:4,worldCenterX:2,worldCenterY:2,minWorldWidth:1e-5,minWorldHeight:1e-5,minWorldX:0,minWorldY:0,maxWorldX:4,maxWorldY:4,clampWorldCoordinatesMode:"both",onResizeCanvas:()=>this.needNewFrame=!0,interactionOptions:{useForPanAndZoom:!0,onPanAndZoom:()=>this.needNewFrame=!0},fullscreenOptions:{onSwitch:this.switchFullscreen.bind(this),beforeSwitch:this.beforeSwitchFullscreen.bind(this),fillScreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"}},i=(this.wilson=new WilsonGPU(canvas,i),{shader:tempShader,canvasWidth:this.resolutionHidden});this.wilsonHidden=new WilsonGPU(e,i),this.resume()}run({generatingString}){var e=generatingString.split("").map(l=>"B"===l?1:0),i=`
