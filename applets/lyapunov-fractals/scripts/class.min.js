"use strict";class LyapunovFractal extends Applet{wilsonHidden=null;aspectRatio=1;numIterations=100;pastBrightnessScales=[];resolution=500;resolutionHidden=100;lastTimestamp=-1;constructor(i){super(i),this.pan.minX=0,this.pan.maxX=4,this.pan.minY=0,this.pan.maxY=4;let s=this.createHiddenCanvas(),e="precision highp float; varying vec2 uv; void main(void) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }",n={renderer:"gpu",shader:e,canvasWidth:500,canvasHeight:500,worldWidth:4,worldHeight:4,worldCenterX:2,worldCenterY:2,useFullscreen:!0,trueFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png",switchFullscreenCallback:this.changeAspectRatio.bind(this,!0),mousedownCallback:this.onGrabCanvas.bind(this),touchstartCallback:this.onGrabCanvas.bind(this),mousedragCallback:this.onDragCanvas.bind(this),touchmoveCallback:this.onDragCanvas.bind(this),mouseupCallback:this.onReleaseCanvas.bind(this),touchendCallback:this.onReleaseCanvas.bind(this),wheelCallback:this.onWheelCanvas.bind(this),pinchCallback:this.onPinchCanvas.bind(this)},t={renderer:"gpu",shader:e,canvasWidth:100,canvasHeight:100};this.wilson=new Wilson(i,n),this.wilsonHidden=new Wilson(s,t),this.zoom.init(),console.log(this.zoom.level);let o=this.changeAspectRatio.bind(this,!0);window.addEventListener("resize",o),this.handlers.push([window,"resize",o])}run(i){let s=[];for(let e=0;e<i.length;e++)"B"===i[e]?s.push(1):s.push(0);let n=`
   ...
   void main(void)
   {
    ...
    for (int iteration = 0; iteration < ${Math.floor(250/i.length)}; iteration++)
    {
