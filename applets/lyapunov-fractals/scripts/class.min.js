import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{addTemporaryListener}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";class LyapunovFractal extends AnimationFrameApplet{wilsonHidden=null;aspectRatio=1;numIterations=100;pastBrightnessScales=[];resolution=500;resolutionHidden=100;constructor({canvas}){super(canvas);var i=this.createHiddenCanvas(),e=`
