import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{getFloatGlsl}from"/scripts/applets/applet.min.js";import{sleep}from"/scripts/src/main.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";const moveToHereVecs={north:"vec2(0.0, stepSize)",east:"vec2(stepSize, 0.0)",south:"vec2(0.0, -stepSize)",west:"vec2(-stepSize, 0.0)"},directionValues={north:getFloatGlsl(1),south:getFloatGlsl(.75),east:getFloatGlsl(.5),west:getFloatGlsl(.25)};function getUpdateShader(direction){var e=directionValues[direction];return`
