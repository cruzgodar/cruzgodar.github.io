import{Applet}from"/scripts/src/applets.mjs";class JuliaSetMosaic extends Applet{wilsonHidden=null;aspectRatio=1;numIterations=100;exposure=1;zoomLevel=0;pastBrightnessScales=[];a=0;b=0;resolution=500;resolutionHidden=50;lastTimestamp=-1;constructor(i){super(i);var s=this.createHiddenCanvas(),e=(this.pan.minX=-2.75,this.pan.maxX=1.25,this.pan.minY=-2,this.pan.maxY=2,"precision highp float; varying vec2 uv; void main(void) { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }"),n={renderer:"gpu",shader:e,canvasWidth:this.resolution,canvasHeight:this.resolution,worldCenterX:-.75,worldCenterY:0,useFullscreen:!0,trueFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png",switchFullscreenCallback:()=>this.changeAspectRatio(!0),mousedownCallback:this.onGrabCanvas.bind(this),touchstartCallback:this.onGrabCanvas.bind(this),mousedragCallback:this.onDragCanvas.bind(this),touchmoveCallback:this.onDragCanvas.bind(this),mouseupCallback:this.onReleaseCanvas.bind(this),touchendCallback:this.onReleaseCanvas.bind(this),wheelCallback:this.onWheelCanvas.bind(this),pinchCallback:this.onPinchCanvas.bind(this)},i=(this.wilson=new Wilson(i,n),{renderer:"gpu",shader:e,canvasWidth:this.resolutionHidden,canvasHeight:this.resolutionHidden}),n=(this.wilsonHidden=new Wilson(s,i),this.zoom.init(),()=>this.changeAspectRatio(!0));window.addEventListener("resize",n),this.handlers.push([window,"resize",n])}run(i=1e3,s=10,e=1,n=100){this.resolution=i,this.wilson.changeCanvasSize(this.resolution,this.resolution),this.setDensity=s,this.exposure=e,this.numIterations=n;i=`
