import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{siteSettings}from"/scripts/src/settings.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class JuliaSetMosaic extends AnimationFrameApplet{wilsonHidden;aspectRatio=1;numIterations=100;zoomLevel=0;pastBrightnessScales=[];c=[0,0];resolution=500;resolutionHidden=50;constructor({canvas}){super(canvas);var e={shader:`
