import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";class CurvedLight extends RaymarchApplet{constructor({canvas,xrFramebufferScaleSlider}){super({canvas:canvas,distanceEstimatorGlsl:`
		...
		`,uniformsGlsl:`
			...
			uniform float c4;
			uniform float c5;
		`,uniforms:{radius:5,curvature:1,c0:1,c1:0,c2:0,c3:0,c4:0,c5:0},focalLengthFactor:2,sceneOrigin:[2.0842,2.0852,2.0637],theta:1.25*Math.PI,phi:2.1539,lightBrightness:1,oppositeLightBrightness:1,ambientLight:.25,fogScaling:.05,useBloom:!1,useReflections:!0,lockedOnOrigin:!1,xrFramebufferScaleSlider:xrFramebufferScaleSlider})}distanceEstimator(){return 1}}export{CurvedLight};