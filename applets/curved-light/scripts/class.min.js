import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";class CurvedLight extends RaymarchApplet{constructor({canvas}){super({canvas:canvas,distanceEstimatorGlsl:`
		...
		`,uniforms:{radius:["float",5],curvature:["float",1],c0:["float",1],c1:["float",0],c2:["float",0],c3:["float",0],c4:["float",0],c5:["float",0]},focalLengthFactor:2,cameraPos:[2.0842,2.0852,2.0637],theta:1.25*Math.PI,phi:2.1539,lightBrightness:1.25,useOppositeLight:!0,oppositeLightBrightness:1,ambientLight:.25,useBloom:!1,useReflections:!0,lockedOnOrigin:!1})}distanceEstimator(){return 1}}export{CurvedLight};