import{FlagOverlap}from"./class.min.js";import{countriesByName,countryNameList,countryNames,possibleAnswers}from"./countryData.min.js";import{Button}from"/scripts/src/buttons.min.js";import{addHoverEvent,addHoverEventWithScale}from"/scripts/src/hoverEvents.min.js";import{$,$$,addTemporaryListener}from"/scripts/src/main.min.js";import{fuzzySearch}from"/scripts/src/utils.min.js";export default async function(){const r=new FlagOverlap({canvas:$("#output-canvas"),overlayCanvas:$("#overlay-canvas"),guessCanvases:Array.from($$(".guess-canvas")),overlayCanvases:Array.from($$(".overlay-canvas")),progressBars:Array.from($$(".progress-bar")),overlapCheckboxes:Array.from($$(".guess-overlap-checkbox")),winOverlay:$("#win-overlay")});new Button({element:$("#replay-button"),name:"Play Again",onClick:()=>r.replay()}),r.possibleFlags=possibleAnswers.all;for(const[p,u]of r.overlapCheckboxes.entries())addHoverEventWithScale({element:u,scale:1.1,addBounceOnTouch:()=>!0}),u.addEventListener("click",()=>{u.classList.toggle("checked"),r.setShowDiffs(u.classList.contains("checked"),p)});let t=!1,n=!1,a=0,o=possibleAnswers.all,l=Array.from({length:possibleAnswers.all.length},(_,i)=>i),i=[...l];const c=$("#guess-selector-input"),d=$("#country-list");for(const[f,h]of o.entries()){const g=document.createElement("div");g.classList.add("country-list-item"),g.innerHTML=`
