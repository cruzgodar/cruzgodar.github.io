import{getGlslBundle,loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{changeOpacity}from"/scripts/src/animation.min.js";import{$$,addTemporaryListener}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";class FractalSounds extends AnimationFrameApplet{loadPromise=null;wilsonHidden=null;wilsonJulia=null;juliaMode=0;aspectRatio=1;numIterations=200;exposure=1;zoomLevel=0;pastBrightnessScales=[];resolution=500;resolutionHidden=200;needToClear=!1;fixedPointX=0;fixedPointY=0;moved=0;lastX=0;lastY=0;zoomingWithMouse=!1;constructor({canvas,lineDrawerCanvas}){super(canvas),this.pan.minX=-3,this.pan.maxX=3,this.pan.minY=-3,this.pan.maxY=3;var e=`
