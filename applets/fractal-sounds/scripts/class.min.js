import{getGlslBundle,loadGlsl}from"../../../scripts/src/complexGlsl.min.js";import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{tempShader}from"/scripts/applets/applet.min.js";import{changeOpacity}from"/scripts/src/animation.min.js";import{convertColor}from"/scripts/src/browser.min.js";import{$$}from"/scripts/src/main.min.js";import{siteSettings}from"/scripts/src/settings.min.js";import{WilsonCPU,WilsonGPU}from"/scripts/wilson.min.js";class FractalSounds extends AnimationFrameApplet{loadPromise;wilsonHidden;wilsonJulia;juliaMode=0;aspectRatio=1;numIterations=200;zoomLevel=0;pastBrightnessScales=[];resolution=500;resolutionHidden=100;needToClear=!1;fixedPointX=0;fixedPointY=0;moved=0;lastX=0;lastY=0;constructor({canvas,lineDrawerCanvas}){super(canvas);var e={shader:tempShader,canvasWidth:this.resolution,reduceMotion:siteSettings.reduceMotion,fullscreenOptions:{fillScreen:!0,animate:!1,closeWithEscape:!1}},e=(this.wilsonJulia=new WilsonGPU(canvas,e),this.createHiddenCanvas()),t={shader:tempShader,canvasWidth:this.resolutionHidden},e=(this.wilsonHidden=new WilsonGPU(e,t),{canvasWidth:1500,worldWidth:4,minWorldX:-3,maxWorldX:3,minWorldY:-3,maxWorldY:3,reduceMotion:siteSettings.reduceMotion,onResizeCanvas:()=>this.needNewFrame=!0,interactionOptions:{useForPanAndZoom:!0,onPanAndZoom:()=>this.needNewFrame=!0,callbacks:{mousemove:this.onHoverCanvas.bind(this),mousedown:this.onGrabCanvas.bind(this),touchstart:this.onGrabCanvas.bind(this),mousedrag:this.onDragCanvas.bind(this),touchmove:this.onDragCanvas.bind(this),mouseup:this.onReleaseCanvas.bind(this),touchend:this.onReleaseCanvas.bind(this),wheel:this.onWheelCanvas.bind(this)}},fullscreenOptions:{fillScreen:!0,onSwitch:this.onSwitchFullscreen.bind(this),useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"}}),t=(this.wilson=new WilsonCPU(lineDrawerCanvas,e),this.wilsonForFullscreen=this.wilson,this.addHoverEventOnFullscreenButton(),$$(".WILSON_fullscreen-container"));t[0].style.setProperty("z-index",200,"important"),t[1].style.setProperty("z-index",300,"important"),this.wilson.ctx.lineWidth=40,this.loadPromise=loadGlsl()}run({glslCode,jsCode,resolution,numIterations}){this.currentFractalFunction=jsCode,this.resolution=resolution,this.numIterations=numIterations;var e=`
