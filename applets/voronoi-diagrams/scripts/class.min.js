import{Applet,getMinGlslString,getVectorGlsl,hsvToRgb,tempShader}from"../../../scripts/applets/applet.min.js";import anime from"/scripts/anime.min.js";import{sleep}from"/scripts/src/utils.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class VoronoiDiagrams extends Applet{wilsonHidden;anime;lastTimestamp=-1;currentlyAnimating=!1;numPoints=20;metric=2;resolution=1e3;resolutionHidden=100;maximumSpeed;drawPoints;useDraggable;t;radius;maxRadius;pointRadius;pointOpacity;points;colors;cancelAnimaton=()=>{};constructor({canvas}){super(canvas);var i={shader:tempShader,canvasWidth:this.resolution,draggableOptions:{draggables:{point0:[0,0]},callbacks:{drag:this.onDragDraggable.bind(this)}},fullscreenOptions:{onSwitch:this.switchFullscreen.bind(this),beforeSwitch:this.beforeSwitchFullscreen.bind(this),useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"},verbose:window.DEBUG},i=(this.wilson=new WilsonGPU(this.canvas,i),this.wilson.draggables.point0.element.style.display="none",{shader:tempShader,canvasWidth:this.resolutionHidden,verbose:window.DEBUG});this.wilsonHidden=new WilsonGPU(this.createHiddenCanvas(),i)}async run({resolution=500,numPoints=20,metric=2,maximumSpeed=!1,drawPoints=!1,useDraggable=!1}){this.resolution=resolution,this.numPoints=numPoints,this.metric=metric,this.maximumSpeed=maximumSpeed,this.drawPoints=drawPoints,this.useDraggable=useDraggable,this.t=-.1,this.radius=-.1,this.pointOpacity=1,this.lastTimestamp=-1,this.wilson.resizeCanvas({width:this.resolution}),this.generatePoints();var i=this.getShader(!0),t=this.getShader(!1);this.wilsonHidden.loadShader({shader:i,uniforms:{radius:this.radius,metric:this.metric,...this.useDraggable?{point0:this.wilson.draggables.point0.location}:{}}}),this.maximumSpeed?this.maxRadius=8:this.maxRadius=this.findMaxRadius(),this.wilson.loadShader({shader:t,uniforms:{radius:this.radius,pointOpacity:this.pointOpacity,metric:this.metric,...this.useDraggable?{point0:this.wilson.draggables.point0.location}:{}}}),this.wilson.draggables.point0.element.style.display=this.useDraggable?"block":"none";const s={t:-.3,pointOpacity:1};let n=!(this.currentlyAnimating=!0);this.cancelAnimaton(),this.cancelAnimaton=()=>{this.currentlyAnimating=!1,n=!0},this.maximumSpeed?(this.t=1,this.pointOpacity=this.drawPoints?1:0,this.drawFrame(),this.currentlyAnimating=!1):this.anime=anime({targets:s,t:1,pointOpacity:this.drawPoints?1:-.5,duration:3e3,delay:2*this.numPoints,easing:"easeOutQuad",update:()=>{n||(this.t=s.t,this.pointOpacity=Math.max(s.pointOpacity,0),this.drawFrame())},complete:()=>{n||(this.anime=null,this.currentlyAnimating=!1)}})}getShader(forHiddenCanvas=!1){var i=forHiddenCanvas?`
