import anime from"/scripts/anime.min.js";import{RaymarchApplet}from"/scripts/src/applets.min.mjs";import{aspectRatio}from"/scripts/src/layout.min.mjs";import{addTemporaryListener}from"/scripts/src/main.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class Mandelbulb extends RaymarchApplet{theta=4.6601;phi=2.272;cameraPos=[.0828,2.17,1.8925];power=8;c=[0,0,0];cOld=[0,0,0];cDelta=[0,0,0];rotationAngleX=0;rotationAngleY=0;rotationAngleZ=0;juliaProportion=0;constructor({canvas}){super(canvas);var t={renderer:"gpu",shader:`
