import anime from"/scripts/anime.min.js";import{RaymarchApplet}from"/scripts/applets/raymarchApplet.min.js";import{aspectRatio}from"/scripts/src/layout.min.js";import{addTemporaryListener}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";class Mandelbulb extends RaymarchApplet{theta=4.6601;phi=2.272;cameraPos=[.0718,1.6264,1.4416];power=8;c=[0,0,0];cOld=[0,0,0];cDelta=[0,0,0];maxIterations=16;rotationAngleX=0;rotationAngleY=0;rotationAngleZ=0;juliaProportion=0;constructor({canvas}){super(canvas);var t={renderer:"gpu",shader:`
