...
`;function getDistanceEstimatorGlsl(useForGetColor=!1){return`
	...
	`}class MengerSponge extends RaymarchApplet{scale=3;separation=1;maxIterations=16;cameraPos=[2.016,1.3095,1.3729];theta=3.7518;phi=2.1482;constructor({canvas}){super(canvas);var e={renderer:"gpu",shader:`
