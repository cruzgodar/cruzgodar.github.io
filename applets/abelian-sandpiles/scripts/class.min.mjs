import{Applet}from"/scripts/src/applets.mjs";class AbelianSandpile extends Applet{wilsonUpscale=null;numGrains=1e4;resolution=500;lastTimestamp=-1;computationsPerFrame=20;lastPixelData=null;constructor(e){super(e);var t=this.createHiddenCanvas(),s={renderer:"gpu",shader:`
		...
		`,canvasWidth:this.resolution,canvasHeight:this.resolution},t=(this.wilson=new Wilson(t,s),this.wilson.render.loadNewShader(`
			precision highp float;
			precision highp sampler2D;
