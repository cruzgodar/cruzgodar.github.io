import{Applet}from"/scripts/src/applets.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class AbelianSandpile extends Applet{wilsonUpscale=null;numGrains=1e4;resolution=500;lastTimestamp=-1;computationsPerFrame=20;lastPixelData=null;constructor({canvas}){super(canvas);var e=this.createHiddenCanvas(),t={renderer:"gpu",shader:`
		...
		`,canvasWidth:this.resolution,canvasHeight:this.resolution},e=(this.wilson=new Wilson(e,t),this.wilson.render.loadNewShader(`
			precision highp float;
			precision highp sampler2D;
