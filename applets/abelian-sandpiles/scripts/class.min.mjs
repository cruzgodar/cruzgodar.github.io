import{Applet}from"/scripts/src/applets.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";class AbelianSandpile extends Applet{wilsonUpscale=null;numGrains=1e4;resolution=500;lastTimestamp=-1;computationsPerFrame=20;lastPixelData=null;constructor(e){super(e);var t=this.createHiddenCanvas(),s={renderer:"gpu",shader:`
