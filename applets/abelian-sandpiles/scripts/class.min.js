import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{siteSettings}from"/scripts/src/settings.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class AbelianSandpile extends AnimationFrameApplet{numGrains=1e4;floodGrains=0;resolution=319;computationsPerFrame=20;lastPixelData;constructor({canvas}){super(canvas);var e=[[229,190,237],[149,147,217],[124,144,219]],e={shaders:{init:`
		...
		`,draw:`
			...
			const vec4 color1 = vec4(${e[0].join(", ")}, 255) / 255.0;
			const vec4 color2 = vec4(${e[1].join(", ")}, 255) / 255.0;
			const vec4 color3 = vec4(${e[2].join(", ")}, 255) / 255.0;
