"use strict";class AbelianSandpile extends Applet{loadPromise=null;wilsonUpscale=null;numGrains=1e4;resolution=500;lastTimestamp=-1;computationsPerFrame=20;lastPixelData=null;constructor(e){super(e);let t=this.createHiddenCanvas(),s=`
  ...
  `,n={renderer:"gpu",shader:l,canvasWidth:this.resolution,canvasHeight:this.resolution,useFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"};this.wilsonUpscale=new Wilson(e,n),this.wilsonUpscale.render.createFramebufferTexturePair(this.wilsonUpscale.gl.UNSIGNED_BYTE)}run(e=1e4,t=25){this.resume(),this.numGrains=e,this.resolution=Math.floor(Math.sqrt(this.numGrains))+2,this.resolution=this.resolution+1-this.resolution%2,this.computationsPerFrame=t;let s=this.numGrains%256/256,i=Math.floor(this.numGrains/256)%256/256,r=Math.floor(this.numGrains/65536)%256/256,o=Math.floor(this.numGrains/16777216)%256/256;this.wilson.gl.useProgram(this.wilson.render.shaderPrograms[0]),this.wilson.gl.uniform1f(this.wilson.uniforms.step[0],1/this.resolution),this.wilson.gl.uniform4f(this.wilson.uniforms.startGrains[0],o,r,i,s),this.wilson.gl.useProgram(this.wilson.render.shaderPrograms[1]),this.wilson.gl.uniform1f(this.wilson.uniforms.step[1],1/this.resolution),this.wilson.changeCanvasSize(this.resolution,this.resolution),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture),this.wilson.gl.texImage2D(this.wilson.gl.TEXTURE_2D,0,this.wilson.gl.RGBA,this.wilson.canvasWidth,this.wilson.canvasHeight,0,this.wilson.gl.RGBA,this.wilson.gl.FLOAT,null),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[1].texture),this.wilson.gl.texImage2D(this.wilson.gl.TEXTURE_2D,0,this.wilson.gl.RGBA,this.wilson.canvasWidth,this.wilson.canvasHeight,0,this.wilson.gl.RGBA,this.wilson.gl.FLOAT,null);let l=Math.max(this.resolution,this.canvas.getBoundingClientRect().width);this.wilsonUpscale.gl.bindTexture(this.wilsonUpscale.gl.TEXTURE_2D,this.wilsonUpscale.render.framebuffers[0].texture),this.wilsonUpscale.changeCanvasSize(l,l),this.wilson.gl.useProgram(this.wilson.render.shaderPrograms[0]),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,this.wilson.render.framebuffers[0].framebuffer),this.wilson.render.drawFrame(),window.requestAnimationFrame(this.drawFrame.bind(this))}drawFrame(e){let t=e-this.lastTimestamp;if(this.lastTimestamp=e,0===t)return;this.wilson.gl.viewport(0,0,this.resolution,this.resolution);for(let s=0;s<this.computationsPerFrame;s++)this.wilson.gl.useProgram(this.wilson.render.shaderPrograms[1]),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,this.wilson.render.framebuffers[1].framebuffer),this.wilson.render.drawFrame(),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[1].texture),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,this.wilson.render.framebuffers[0].framebuffer),this.wilson.render.drawFrame(),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture);this.wilson.gl.useProgram(this.wilson.render.shaderPrograms[2]),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,null),this.wilson.render.drawFrame();let i=this.wilson.render.getPixelData();if(null!==this.lastPixelData){let r=!1;for(let o=0;o<i.length;o++)if(i[o]!==this.lastPixelData[o]){r=!0;break}if(!r)return}this.lastPixelData=i,this.wilsonUpscale.gl.texImage2D(this.wilsonUpscale.gl.TEXTURE_2D,0,this.wilsonUpscale.gl.RGBA,this.wilson.canvasWidth,this.wilson.canvasHeight,0,this.wilsonUpscale.gl.RGBA,this.wilsonUpscale.gl.UNSIGNED_BYTE,i),this.wilsonUpscale.gl.bindFramebuffer(this.wilsonUpscale.gl.FRAMEBUFFER,null),this.wilsonUpscale.render.drawFrame(),this.animationPaused||window.requestAnimationFrame(this.drawFrame.bind(this))}}