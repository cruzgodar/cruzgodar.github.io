import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{sleep}from"/scripts/src/main.min.js";import{WilsonGPU}from"/scripts/wilson.min.js";class AbelianSandpiles extends AnimationFrameApplet{wilsonUpdate;numGrains;floodGrains;resolution=319;resolutionUpdate;computationsPerFrame=20;lastPixelData;constructor({canvas}){super(canvas);var e=this.createHiddenCanvas(),t={shaders:{init:`
