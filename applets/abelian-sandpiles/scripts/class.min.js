import{AnimationFrameApplet}from"/scripts/applets/animationFrameApplet.min.js";import{sleep}from"/scripts/src/utils.min.js";import{WilsonGL}from"/scripts/wilson.min.js";class AbelianSandpiles extends AnimationFrameApplet{wilsonUpdate;numGrains;floodGrains;resolution=319;resolutionUpdate;computationsPerFrame=20;lastPixelData;constructor({canvas}){super(canvas);var e=this.createHiddenCanvas(),t={shaders:{init:`
		...
		`},uniforms:{init:{stepSize:0,startGrains:[0,0,0,0],floodGrains:[0,0,0,0]},update:{stepSize:0}},canvasWidth:Math.ceil(this.resolution/2),verbose:window.DEBUG},e=(this.wilsonUpdate=new WilsonGL(e,t),{shader:`
			precision highp float;
			precision highp sampler2D;
