"use strict";class AbelianSandpile extends Applet{load_promise=null;wilson_upscale=null;num_grains=1e4;resolution=500;last_timestamp=-1;computations_per_frame=20;last_pixel_data=null;constructor(e){super(e);let t=this.create_hidden_canvas(),s=`
  ...
  `,o={renderer:"gpu",shader:s,canvas_width:this.resolution,canvas_height:this.resolution};this.wilson=new Wilson(t,o),this.wilson.render.load_new_shader(i),this.wilson.render.load_new_shader(r),this.wilson.render.init_uniforms(["step","start_grains"],0),this.wilson.render.init_uniforms(["step"],1),this.wilson.render.create_framebuffer_texture_pair(),this.wilson.render.create_framebuffer_texture_pair(),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,null);let l=`
   precision highp float;
   precision highp sampler2D;
  ...
  `,n={renderer:"gpu",shader:l,canvas_width:this.resolution,canvas_height:this.resolution,use_fullscreen:!0,use_fullscreen_button:!0,enter_fullscreen_button_icon_path:"/graphics/general-icons/enter-fullscreen.png",exit_fullscreen_button_icon_path:"/graphics/general-icons/exit-fullscreen.png"};this.wilson_upscale=new Wilson(e,n),this.wilson_upscale.render.create_framebuffer_texture_pair(this.wilson_upscale.gl.UNSIGNED_BYTE)}run(e=1e4,t=25){this.resume(),this.num_grains=e,this.resolution=Math.floor(Math.sqrt(this.num_grains))+2,this.resolution=this.resolution+1-this.resolution%2,this.computations_per_frame=t;let s=this.num_grains%256/256,i=Math.floor(this.num_grains/256)%256/256,r=Math.floor(this.num_grains/65536)%256/256,o=Math.floor(this.num_grains/16777216)%256/256;this.wilson.gl.useProgram(this.wilson.render.shader_programs[0]),this.wilson.gl.uniform1f(this.wilson.uniforms.step[0],1/this.resolution),this.wilson.gl.uniform4f(this.wilson.uniforms.start_grains[0],o,r,i,s),this.wilson.gl.useProgram(this.wilson.render.shader_programs[1]),this.wilson.gl.uniform1f(this.wilson.uniforms.step[1],1/this.resolution),this.wilson.change_canvas_size(this.resolution,this.resolution),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture),this.wilson.gl.texImage2D(this.wilson.gl.TEXTURE_2D,0,this.wilson.gl.RGBA,this.wilson.canvas_width,this.wilson.canvas_height,0,this.wilson.gl.RGBA,this.wilson.gl.FLOAT,null),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[1].texture),this.wilson.gl.texImage2D(this.wilson.gl.TEXTURE_2D,0,this.wilson.gl.RGBA,this.wilson.canvas_width,this.wilson.canvas_height,0,this.wilson.gl.RGBA,this.wilson.gl.FLOAT,null);let l=Math.max(this.resolution,this.canvas.getBoundingClientRect().width);this.wilson_upscale.gl.bindTexture(this.wilson_upscale.gl.TEXTURE_2D,this.wilson_upscale.render.framebuffers[0].texture),this.wilson_upscale.change_canvas_size(l,l),this.wilson.gl.useProgram(this.wilson.render.shader_programs[0]),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,this.wilson.render.framebuffers[0].framebuffer),this.wilson.render.draw_frame(),window.requestAnimationFrame(this.draw_frame.bind(this))}draw_frame(e){let t=e-this.last_timestamp;if(this.last_timestamp=e,0===t)return;this.wilson.gl.viewport(0,0,this.resolution,this.resolution);for(let s=0;s<this.computations_per_frame;s++)this.wilson.gl.useProgram(this.wilson.render.shader_programs[1]),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,this.wilson.render.framebuffers[1].framebuffer),this.wilson.render.draw_frame(),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[1].texture),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,this.wilson.render.framebuffers[0].framebuffer),this.wilson.render.draw_frame(),this.wilson.gl.bindTexture(this.wilson.gl.TEXTURE_2D,this.wilson.render.framebuffers[0].texture);this.wilson.gl.useProgram(this.wilson.render.shader_programs[2]),this.wilson.gl.bindFramebuffer(this.wilson.gl.FRAMEBUFFER,null),this.wilson.render.draw_frame();let i=this.wilson.render.get_pixel_data();if(null!==this.last_pixel_data){let r=!1;for(let o=0;o<i.length;o++)if(i[o]!==this.last_pixel_data[o]){r=!0;break}if(!r)return}this.last_pixel_data=i,this.wilson_upscale.gl.texImage2D(this.wilson_upscale.gl.TEXTURE_2D,0,this.wilson_upscale.gl.RGBA,this.wilson.canvas_width,this.wilson.canvas_height,0,this.wilson_upscale.gl.RGBA,this.wilson_upscale.gl.UNSIGNED_BYTE,i),this.wilson_upscale.gl.bindFramebuffer(this.wilson_upscale.gl.FRAMEBUFFER,null),this.wilson_upscale.render.draw_frame(),this.animation_paused||window.requestAnimationFrame(this.draw_frame.bind(this))}}