...
function tryToAddCageToCage(cageToDestroy, cageToGrow)
{
	...
	// Now we don't have easy access to the quotient of cageToDestroy, so what we'll do
	// in both cases is take the max digit squared over the products of both cages
	// multiplied together. If this division is remainderless, we're golden.
