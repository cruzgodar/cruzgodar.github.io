!function()
{
	...
	
	{
		...
		Page.Load.AOS.elements[1].splice(Page.Load.AOS.elements[1].length - 2, 0, [wilson.draggables.container, Page.Load.AOS.elements[1][Page.Load.AOS.elements[1].length - 2][1]]);
		
		Page.Load.AOS.show_section(1);
