import{showPage}from"../../../../../scripts/src/loadPage.min.js";import{$,$$,addTemporaryListener}from"/scripts/src/main.min.js";import{Wilson}from"/scripts/wilson.min.js";!function(){"use strict";var e=$$("pre code");for(let r=0;r<e.length;r++)e[r].classList.add("highlightable");hljs.highlightAll();{var a=`
