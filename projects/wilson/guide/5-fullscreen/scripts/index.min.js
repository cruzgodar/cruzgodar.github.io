!function(){"use strict";let e=Page.element.querySelectorAll("pre code");for(let r=0;r<e.length;r++)e[r].classList.add("highlightable");hljs.highlightAll();{let n=`
  ...
  `,t=new Wilson(Page.element.querySelector("#output-canvas-1"),{renderer:"gpu",shader:n,canvasWidth:1e3,canvasHeight:1e3,worldWidth:4,worldHeight:4,worldCenterX:0,worldCenterY:0,useDraggables:!0,draggablesMousemoveCallback:u,draggablesTouchmoveCallback:u,useFullscreen:!0,useFullscreenButton:!0,enterFullscreenButtonIconPath:"/graphics/general-icons/enter-fullscreen.png",exitFullscreenButtonIconPath:"/graphics/general-icons/exit-fullscreen.png"});t.render.initUniforms(["a","b","brightnessScale"]),t.draggables.add(0,1);let a=new Wilson(Page.element.querySelector("#hidden-canvas-1"),{renderer:"gpu",shader:n,canvasWidth:100,canvasHeight:100});a.render.initUniforms(["a","b","brightnessScale"]),t.canvas.parentNode.parentNode.style.setProperty("margin-bottom",0,"important"),a.canvas.parentNode.parentNode.style.setProperty("margin-top",0,"important");let i=0,o=1,l=1e3,s=-1,c=Page.element.querySelector("#resolution-1-input");c.addEventListener("input",()=>{l=parseInt(c.value||1e3),t.changeCanvasSize(l,l)});function u(e,r,n,t){i=r,o=n,window.requestAnimationFrame($)}function $(e){let r=e-s;if(s=e,0===r)return;a.gl.uniform1f(a.uniforms.a,i),a.gl.uniform1f(a.uniforms.b,o),a.gl.uniform1f(a.uniforms.brightnessScale,20),a.render.drawFrame();let n=a.render.getPixelData(),l=Array(1e4);for(let c=0;c<1e4;c++)l[c]=n[4*c]+n[4*c+1]+n[4*c+2];l.sort((e,r)=>e-r);let u=l[Math.floor(9800)]/255*18;u=Math.max(u,.1),t.gl.uniform1f(t.uniforms.a,i),t.gl.uniform1f(t.uniforms.b,o),t.gl.uniform1f(t.uniforms.brightnessScale,u),t.render.drawFrame()}Page.element.querySelector("#download-1-button").addEventListener("click",()=>{t.downloadFrame("a-julia-set.png")}),t.changeCanvasSize(l,l),window.requestAnimationFrame($)}{let g=`
   precision highp float;
