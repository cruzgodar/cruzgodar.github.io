import{showPage}from"/scripts/src/load-page.min.min.mjs";import{$,$$,addTemporaryListener}from"/scripts/src/main.min.min.mjs";import{Wilson}from"/scripts/wilson.min.min.mjs";!function(){"use strict";var e=$$("pre code");for(let r=0;r<e.length;r++)e[r].classList.add("highlightable");hljs.highlightAll();{var a=`
