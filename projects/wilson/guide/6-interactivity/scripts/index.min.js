import{showPage}from"/scripts/src/load-page.min.mjs";import{$,$$,addTemporaryListener}from"/scripts/src/main.min.mjs";import{Wilson}from"/scripts/wilson.min.mjs";!function(){"use strict";var r=$$("pre code");for(let e=0;e<r.length;e++)r[e].classList.add("highlightable");hljs.highlightAll();{var n=`
