import{getFloatGlsl,getVectorGlsl}from"./applet.min.js";function getComputeShadowIntensityGlsl({useShadows,useSoftShadows,getGeodesicGlsl}){return useShadows&&useSoftShadows?`
	...
	`}function getRaymarchGlsl({getGeodesicGlsl,stepFactor,overstepFactor}){return`
		void raymarch(
			vec3 rayOrigin,
	...
	`)}function createShader({distanceEstimatorGlsl,getColorGlsl,getReflectivityGlsl,getGeodesicGlsl,addGlsl,includeDepthData,useShadows,useSoftShadows,useReflections,useOppositeLight,useGradientCorrectedOcclusion,oppositeLightBrightness,ambientLight,useBloom,bloomPower,stepFactor,overstepFactor,surfaceNormalEpsilonFactor,useFor3DPrinting,aoSamples,aoStrength,uniformsGlsl,lightPos,lightBrightness,clipDistance,maxMarches,maxShadowMarches,fogColor,fogScaling}){var e=getComputeShadowIntensityGlsl({useShadows:useShadows,useSoftShadows:useSoftShadows,getGeodesicGlsl:getGeodesicGlsl,stepFactor:stepFactor}),t=getComputeShadingGlsl({useOppositeLight:useOppositeLight,oppositeLightBrightness:oppositeLightBrightness,ambientLight:ambientLight,useShadows:useShadows,useGradientCorrectedOcclusion:useGradientCorrectedOcclusion}),o=getRaymarchGlsl({getGeodesicGlsl:getGeodesicGlsl,stepFactor:stepFactor,overstepFactor:overstepFactor}),a=getMainFunctionGlsl({useFor3DPrinting:useFor3DPrinting,includeDepthData:includeDepthData,useBloom:useBloom,useShadows:useShadows,useReflections:useReflections,surfaceNormalEpsilonFactor:surfaceNormalEpsilonFactor}),i=useBloom?`
