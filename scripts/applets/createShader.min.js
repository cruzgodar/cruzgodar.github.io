import{doubleEncodingGlsl}from"../src/complexGlsl.min.js";import{getFloatGlsl,getVectorGlsl}from"./applet.min.js";function createShader({distanceEstimatorGlsl,getColorGlsl,getReflectivityGlsl,getGeodesicGlsl,addGlsl,useForDepthBuffer,useShadows,useSoftShadows,useReflections,useOppositeLight,oppositeLightBrightness,ambientLight,useBloom,bloomPower,stepFactor,useFor3DPrinting,uniformsGlsl,lightPos,lightBrightness,clipDistance,maxMarches,maxShadowMarches,maxReflectionMarches,fogColor,fogScaling}){var e=useShadows&&useSoftShadows?`
				...
				vec3 raymarch(vec3 startPos)
				{
					...
					for (int iteration = 0; iteration < maxMarches; iteration++)
					{
						...
						if (distanceToScene < epsilon)
						{
							...
							return vec3(float(iteration) / 255.0);
						}
