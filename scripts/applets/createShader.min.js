import{getFloatGlsl,getVectorGlsl}from"./applet.min.js";function getComputeShadowIntensityGlsl({useShadows,useSoftShadows,getGeodesicGlsl}){return useShadows&&useSoftShadows?`
	...
	`}function getMainFunctionGlsl({useFor3DPrinting,includeDepthData,useBloom,useShadows,useReflections}){var e;return useFor3DPrinting?`
			void main(void)
			{
	...
	`}function createShader({distanceEstimatorGlsl,getColorGlsl,getReflectivityGlsl,getGeodesicGlsl,addGlsl,includeDepthData,useShadows,useSoftShadows,useReflections,useOppositeLight,useGradientCorrectedOcclusion,oppositeLightBrightness,ambientLight,useBloom,bloomPower,stepFactor,overstepFactor,useFor3DPrinting,aoSamples,aoStrength,uniformsGlsl,lightPos,lightBrightness,clipDistance,maxMarches,maxShadowMarches,fogColor,fogScaling}){var e=getComputeShadowIntensityGlsl({useShadows:useShadows,useSoftShadows:useSoftShadows,getGeodesicGlsl:getGeodesicGlsl,stepFactor:stepFactor}),t=getComputeShadingGlsl({useOppositeLight:useOppositeLight,oppositeLightBrightness:oppositeLightBrightness,ambientLight:ambientLight,useShadows:useShadows,useGradientCorrectedOcclusion:useGradientCorrectedOcclusion}),o=getRaymarchGlsl({getGeodesicGlsl:getGeodesicGlsl,stepFactor:stepFactor,overstepFactor:overstepFactor}),i=getMainFunctionGlsl({useFor3DPrinting:useFor3DPrinting,includeDepthData:includeDepthData,useBloom:useBloom,useShadows:useShadows,useReflections:useReflections}),a=useBloom?`
