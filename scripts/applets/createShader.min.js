import{getFloatGlsl,getVectorGlsl}from"./applet.min.js";function getComputeShadowIntensityGlsl({useShadows,useSoftShadows,getGeodesicGlsl}){return useShadows&&useSoftShadows?`
		...
		`:""}function getComputeShadingGlsl({useOppositeLight,oppositeLightBrightness,ambientLight,useShadows}){return`
		vec3 computeShading(
			vec3 pos,
			int iteration,
			vec3 lightDirection,
	...
	`}function getMainFunctionGlsl({useFor3DPrinting,includeDepthData,useBloom,useShadows,useReflections,stepFactor}){var e,t,o;return useFor3DPrinting?`
			void main(void)
			{
		...
		`:(e=includeDepthData?"t":"1.0",t=useBloom?"mix(fogColor, vec3(1.0), computeBloom(rayDirectionVec))":"fogColor",o=useReflections?`
	...
	`)}function createShader({distanceEstimatorGlsl,getColorGlsl,getReflectivityGlsl,getGeodesicGlsl,addGlsl,includeDepthData,useShadows,useSoftShadows,useReflections,useOppositeLight,oppositeLightBrightness,ambientLight,useBloom,bloomPower,stepFactor,overstepFactor,useFor3DPrinting,uniformsGlsl,lightPos,lightBrightness,clipDistance,maxMarches,maxShadowMarches,fogColor,fogScaling}){var e=getComputeShadowIntensityGlsl({useShadows:useShadows,useSoftShadows:useSoftShadows,getGeodesicGlsl:getGeodesicGlsl,stepFactor:stepFactor}),t=getComputeShadingGlsl({useOppositeLight:useOppositeLight,oppositeLightBrightness:oppositeLightBrightness,ambientLight:ambientLight,useShadows:useShadows}),o=getRaymarchGlsl({getGeodesicGlsl:getGeodesicGlsl,stepFactor:stepFactor,overstepFactor:overstepFactor}),i=getMainFunctionGlsl({useFor3DPrinting:useFor3DPrinting,includeDepthData:includeDepthData,useBloom:useBloom,stepFactor:stepFactor,useShadows:useShadows,useReflections:useReflections}),s=useBloom?`
