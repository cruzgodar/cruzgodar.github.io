import{getFloatGlsl,getVectorGlsl}from"./applet.min.js";function getComputeShadowIntensityGlsl({useShadows,useSoftShadows,getGeodesicGlsl}){return useShadows&&useSoftShadows?`
	...
	`}function getRaymarchGlsl({useForDepthBuffer,stepFactor,getGeodesicGlsl,useBloom}){var e=useForDepthBuffer?"t":"1.0",t=useBloom?`
			return vec4(
				mix(fogColor, vec3(1.0), computeBloom(rayDirectionVec)),
				${e}
			);
		`:`
			return vec4(fogColor, ${e});
		`;return`
	...
	`}function getMainFunctionGlsl({useFor3DPrinting}){return useFor3DPrinting?`
			void main(void)
			{
