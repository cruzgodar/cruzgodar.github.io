...
class Lapsa {
    ...
    async nextSlide(skipBuilds = false) {
        ...
        const unload = (_a = this.callbacks[this.slides[this.currentSlide].id]) === null || _a === void 0 ? void 0 : _a.unload;
        ...
        this.buildState = 0;
        const callbacks = this.callbacks[this.slides[this.currentSlide].id];
        (_b = callbacks === null || callbacks === void 0 ? void 0 : callbacks.load) === null || _b === void 0 ? void 0 : _b.call(callbacks, {
            lapsa: this,
            slide: this.slides[this.currentSlide],
        });
        this.setupBuild({
    ...
    async jumpToSlide(index) {
        ...
        // This one needs an extra guard since it's called when beginning the presentation.
    ...
    async closeTableView(selection, duration = this.tableViewAnimationTime) {
        ...
        // with the table view animation.
        const callbacks = this.callbacks[this.slides[this.currentSlide].id];
        (_a = callbacks === null || callbacks === void 0 ? void 0 : callbacks.load) === null || _a === void 0 ? void 0 : _a.call(callbacks, {
            lapsa: this,
            slide: this.slides[this.currentSlide],
        });
        this.setupBuild({
