...
export class WilsonGPU extends Wilson {
    ...
    async enterXR() {
        ...
        if (!navigator.xr
            || __classPrivateFieldGet(this, _WilsonGPU_xrIsSupportedNow, "f") !== true && !(await __classPrivateFieldGet(this, _WilsonGPU_instances, "m", _WilsonGPU_checkXRSupport).call(this))) {
