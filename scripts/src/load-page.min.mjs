...
import { setUpBanner, bannerElement } from "./banners.min.mjs"
import { setUpTextButtons, setUpNavButtons, setUpDropdowns } from "./buttons.min.mjs"
import { addHoverEvent, setUpHoverEvents, setUpFocusEvents } from "./hover-events.min.mjs"
import { typesetMath } from "./math.min.mjs"
import { redirect, navigationTransitionType } from "./navigation.min.mjs"
...
{
	import(`${Page.url}scripts/index.${window.DEBUG ? "mjs" : "min.min.mjs"}`)
