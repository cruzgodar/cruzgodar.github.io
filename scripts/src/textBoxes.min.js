import anime from"../anime.min.js";import{Checkbox}from"./checkboxes.min.js";import{addHoverEventWithScale}from"./hoverEvents.min.js";import{InputElement}from"./inputElement.min.js";import{$$,addTemporaryListener,pageElement}from"./main.min.js";let uncapEverything=!1;class TextBox extends InputElement{defaultValue;valueTypeIsString=!1;constructor({element,name,value,maxValue=1/0,minValue=-1/0,onInput=()=>{},onEnter=()=>{}}){super({element:element,name:name}),this.value=value,this.defaultValue=this.value,this.onInput=onInput,this.onEnter=onEnter,this.maxValue=maxValue,this.minValue=minValue,this.element.value=this.value,this.element.nextElementSibling.textContent=this.name,"string"==typeof this.value&&(this.valueTypeIsString=!0),this.element.addEventListener("input",()=>this.inputCallback()),this.element.addEventListener("focusout",()=>{""===this.element.value&&(this.element.value=this.defaultValue,this.value=this.valueTypeIsString?this.element.value:parseFloat(this.element.value)),this.updateCaps()}),this.element.addEventListener("keydown",e=>{"Enter"!==e.key||this.disabled||(""===this.element.value&&(this.element.value=this.defaultValue,this.value=this.valueTypeIsString?this.element.value:parseFloat(this.element.value)),this.updateCaps(),this.onEnter())}),this.valueTypeIsString||this.setCap()}inputCallback(){this.disabled||(this.value=this.valueTypeIsString?this.element.value||this.defaultValue:parseFloat(this.element.value||this.defaultValue),this.valueTypeIsString||(this.value>this.maxValue&&!uncapEverything?this.value=this.maxValue:this.value<this.minValue&&!uncapEverything?this.value=this.minValue:(this.element.parentNode.classList.remove("capped-input-max"),this.element.parentNode.classList.remove("capped-input-min"))),this.onInput())}updateCaps(){this.valueTypeIsString||uncapEverything||(this.value>=this.maxValue?(this.value=this.maxValue,this.element.value=this.value,this.element.parentNode.classList.remove("capped-input-min"),this.element.parentNode.classList.add("capped-input-max")):this.value<=this.minValue?(this.value=this.minValue,this.element.value=this.value,this.element.parentNode.classList.remove("capped-input-max"),this.element.parentNode.classList.add("capped-input-min")):(this.element.parentNode.classList.remove("capped-input-max"),this.element.parentNode.classList.remove("capped-input-min")))}setValue(newValue,callOnInput=!1){this.value=newValue,this.element.value=this.value,callOnInput&&this.inputCallback()}setCap(){var e=this.element.nextElementSibling.innerHTML.split(" "),t=document.createElement("p");t.classList.add("body-text"),t.style.position="fixed",t.style.opacity=0,t.style.top="-100vh",t.style.width="fit-content",t.textContent="",pageElement.appendChild(t);let a=0;for(let i=0;i<e.length;i++)t.textContent=""+t.textContent+(i===a?"":" ")+e[i],100<=t.getBoundingClientRect().width&&(a=i,i--,t.textContent="");t.remove(),0===a?this.element.nextElementSibling.innerHTML=`<span style="white-space: nowrap">${e.slice(a).join(" ")}<span class="triangle">&#x25BC;</span></span>`:this.element.nextElementSibling.innerHTML=`<span>${e.slice(0,a).join(" ")}</span> <span style="white-space: nowrap">${e.slice(a).join(" ")}<span class="triangle">&#x25BC;</span></span>`,this.element.nextElementSibling.addEventListener("click",()=>{this.element.parentNode.classList.contains("capped-input-max")?(hideAllCapDialogs(),this.showCapDialog()):this.element.parentNode.classList.contains("capped-input-min")&&(hideAllCapDialogs(),this.showCapDialog(!0))});var n=(e=>{e.target.classList.contains("keep-dialog-open")||hideAllCapDialogs()}).bind(this);addTemporaryListener({object:document.documentElement,event:"pointerdown",callback:n,log:!0})}showCapDialog(tooSmall=!1){const t=document.createElement("div");t.classList.add("input-cap-dialog"),t.classList.add("keep-dialog-open"),t.style.opacity=0,t.style.transform="scale(1)",t.innerHTML=tooSmall?`Smaller values than this may cause unexpected results, break the intended functionality of the applet, or crash the tab or entire browser. Only continue if you know what you&#x2019;re doing!
