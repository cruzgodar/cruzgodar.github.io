import anime from"../anime.min.js";import{Checkbox}from"../components/checkboxes.min.js";import{addHoverEvent,addHoverEventWithScale}from"./hoverEvents.min.js";import{redirect}from"./navigation.min.js";import{siteSettings,toggleDarkTheme,toggleDistinguishColors,toggleIncreaseContrast,toggleReduceMotion}from"./settings.min.js";let headerElement,accessibilityTooltipElement,darkThemeCheckbox,reduceMotionCheckbox,increaseContrastCheckbox,distinguishColorsCheckbox,distinguishColorsCheckboxContainer,accessibilityDialogOpen=!1,accessibilityDialogAnimating=!1;function addHeader(){document.body.firstChild.insertAdjacentHTML("beforebegin",`
	...
	`),setTimeout(()=>{var i=document.body.querySelector("#header-logo img");i.style.width=i.getBoundingClientRect().height+"px";for(const c of document.body.querySelectorAll("#header-logo, #header-links a")){var t="header-logo"===c.id?()=>window.innerWidth<=700:()=>window.innerWidth<=550;addHoverEvent({element:c,addBounceOnTouch:t});const o=c.getAttribute("href");c.addEventListener("click",e=>{e.preventDefault(),redirect({url:o,inNewTab:e.metaKey})})}i=document.body.querySelector("#header-settings-button");addHoverEvent({element:i,addBounceOnTouch:()=>!0}),i.addEventListener("click",e=>{e.preventDefault(),(accessibilityDialogOpen?hideAccessibilityDialog:showAccessibilityDialog)()}),accessibilityTooltipElement=document.body.querySelector("#accessibility-tooltip"),document.documentElement.addEventListener("pointerdown",e=>{accessibilityDialogOpen&&!e.target.classList.contains("keep-accessibility-dialog-open")&&hideAccessibilityDialog()}),darkThemeCheckbox=new Checkbox({element:document.body.querySelector("#dark-theme-checkbox"),name:"Dark theme",checked:siteSettings.darkTheme,persistState:!1,onInput:()=>toggleDarkTheme({})}),addHoverEventWithScale({element:darkThemeCheckbox.element.parentNode,scale:1.1,addBounceOnTouch:()=>!0}),reduceMotionCheckbox=new Checkbox({element:document.body.querySelector("#reduce-motion-checkbox"),name:"Reduce motion",checked:siteSettings.reduceMotion,persistState:!1,onInput:()=>toggleReduceMotion()}),addHoverEventWithScale({element:reduceMotionCheckbox.element.parentNode,scale:1.1,addBounceOnTouch:()=>!0}),increaseContrastCheckbox=new Checkbox({element:document.body.querySelector("#increase-contrast-checkbox"),name:"Increase contrast",checked:siteSettings.increaseContrast,persistState:!1,onInput:()=>toggleIncreaseContrast({})}),addHoverEventWithScale({element:increaseContrastCheckbox.element.parentNode,scale:1.1,addBounceOnTouch:()=>!0}),distinguishColorsCheckbox=new Checkbox({element:document.body.querySelector("#distinguish-colors-checkbox"),name:"Distinguish graph colors",checked:siteSettings.distinguishColors,persistState:!1,onInput:()=>toggleDistinguishColors({})}),addHoverEventWithScale({element:distinguishColorsCheckbox.element.parentNode,scale:1.1,addBounceOnTouch:()=>!0}),distinguishColorsCheckboxContainer=distinguishColorsCheckbox.element.parentNode.parentNode.parentNode,headerElement=document.body.querySelector("#header")})}async function showAccessibilityDialog(){accessibilityDialogAnimating||(accessibilityDialogAnimating=!0,accessibilityDialogOpen=!0,accessibilityTooltipElement.style.transform=siteSettings.reduceMotion?"scale(1)":"translateX(8px) translateY(-8px) scale(.95)",accessibilityTooltipElement.style.display="block",await anime({targets:accessibilityTooltipElement,opacity:1,scale:1,translateX:0,translateY:0,duration:150,easing:"easeOutQuad"}).finished,accessibilityDialogAnimating=!1)}async function hideAccessibilityDialog(){accessibilityDialogAnimating||(accessibilityDialogAnimating=!0,accessibilityDialogOpen=!1,await anime({targets:accessibilityTooltipElement,opacity:0,scale:siteSettings.reduceMotion?1:.95,translateX:siteSettings.reduceMotion?0:8,translateY:siteSettings.reduceMotion?0:-8,duration:150,easing:"easeOutQuad"}).finished,accessibilityTooltipElement.style.display="none",accessibilityDialogAnimating=!1)}export{headerElement,darkThemeCheckbox,reduceMotionCheckbox,increaseContrastCheckbox,distinguishColorsCheckbox,distinguishColorsCheckboxContainer,accessibilityDialogOpen,addHeader,hideAccessibilityDialog};