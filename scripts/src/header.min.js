import{addHoverEvent}from"./hoverEvents.min.js";import{redirect}from"./navigation.min.js";import{toggleDarkTheme}from"./settings.min.js";let headerElement=null;function addHeader(){document.body.firstChild.insertAdjacentHTML("beforebegin",`
