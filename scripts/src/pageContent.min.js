import anime from"../anime.min.js";import{cardAnimationTime}from"./animation.min.js";import{convertHtmlToTex}from"./convertHtmlToTex.min.js";import{addHoverEventWithScale}from"./hoverEvents.min.js";import{$,$$,pageElement,pageUrl}from"./main.min.js";import{siteSettings}from"./settings.min.js";import{downloadString}from"./utils.min.js";const contentsSelector=".notes-title, .section-text, .heading-text";let contentsContainerElement,contentsElement,indicatorElement,contentsShown=!1,contentsAnimating=!1;function initPageContents(){const e=$(".nav-buttons");e&&(prepareContents(),window.DEBUG&&e.insertAdjacentHTML("afterend",`
