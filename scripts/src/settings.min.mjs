import{opacityAnimationTime}from"./animation.min.mjs";import{cardIsOpen}from"./cards.min.mjs";import{$,addStyle,pageUrl}from"./main.min.mjs";const forceThemePages={"/gallery/":!0,"/slides/oral-exam/":!0},preventThemeChangePages=["/gallery/","/slides/oral-exam/","/writing/caracore/","/writing/caligo/"],rootElement=document.querySelector(":root"),metaThemeColorElement=document.querySelector("#theme-color-meta"),params=new URLSearchParams(document.location.search),siteSettings={darkTheme:window.matchMedia("(prefers-color-scheme: dark)").matches&&null===params.get("theme")||"1"===params.get("theme"),condensedApplets:"1"===params.get("condensedapplets")};let revertThemeTo=null;function setRevertThemeTo(e){revertThemeTo=e}let forcedTheme=!1;function setForcedTheme(e){forcedTheme=e}function setUpDarkTheme(){window.matchMedia("(prefers-color-scheme: dark)").addListener(e=>{-1!==revertTheme||cardIsOpen||(e.matches&&!siteSettings.darkTheme||!e.matches&&siteSettings.darkTheme)&&toggleDarkTheme()}),siteSettings.darkTheme&&toggleDarkTheme({noAnimation:!(siteSettings.darkTheme=!1)})}function revertTheme(){forcedTheme?forcedTheme=!1:null!==revertThemeTo&&(revertThemeTo=null,siteSettings.darkTheme!==revertThemeTo)&&toggleDarkTheme({})}function toggleDarkTheme({noAnimation:e=!1,force:t=!1}){if(t||!preventThemeChangePages.includes(pageUrl))if(siteSettings.darkTheme=!siteSettings.darkTheme,e)metaThemeColorElement.setAttribute("content",siteSettings.darkTheme?"#181818":"#ffffff"),rootElement.style.setProperty("--theme",siteSettings.darkTheme?1:0);else{const r=addStyle(`
	...
	`);try{$("#download-button").parentNode.parentNode.style.display="none"}catch(e){}}export{forceThemePages,preventThemeChangePages,metaThemeColorElement,siteSettings,setRevertThemeTo,setForcedTheme,setUpDarkTheme,revertTheme,toggleDarkTheme,condenseApplet};